...
function Fc() {
  return Oo || (Oo = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function t(x) {
      ...
      if (B) {
        B = console;
        var H = B.error, I = typeof Symbol == "function" && Symbol.toStringTag && x[Symbol.toStringTag] || x.constructor.name || "Object";
        return H.call(
          B,
    ...
    function r(x) {
      if (x === v) return "<>";
      if (typeof x == "object" && x !== null && x.$$typeof === oe)
        return "<...>";
      try {
        var B = n(x);
        return B ? "<" + B + ">" : "<...>";
    ...
    function f(x, B, H, I, K, ue) {
      ...
      if (E.call(B, "key")) {
        ...
        I = 0 < W.length ? "{key: someKey, " + W.join(": ..., ") + ": ...}" : "{key: someKey}", D[Q + I] || (W = 0 < W.length ? "{" + W.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (Q = null, H !== void 0 && (t(H), Q = "" + H), o(B) && (t(B.key), Q = "" + B.key), "key" in B) {
        H = {};
        for (var te in B)
          te !== "key" && (H[te] = B[te]);
      } else H = B;
    ...
    function m(x) {
      d(x) ? x._store && (x._store.validated = 1) : typeof x == "object" && x !== null && x.$$typeof === oe && (x._payload.status === "fulfilled" ? d(x._payload.value) && x._payload.value._store && (x._payload.value._store.validated = 1) : x._store && (x._store.validated = 1));
    }
    function d(x) {
      return typeof x == "object" && x !== null && x.$$typeof === p;
    }
    var g = Rc, p = Symbol.for("react.transitional.element"), w = Symbol.for("react.portal"), v = Symbol.for("react.fragment"), N = Symbol.for("react.strict_mode"), C = Symbol.for("react.profiler"), L = Symbol.for("react.consumer"), q = Symbol.for("react.context"), j = Symbol.for("react.forward_ref"), G = Symbol.for("react.suspense"), z = Symbol.for("react.suspense_list"), ie = Symbol.for("react.memo"), oe = Symbol.for("react.lazy"), pe = Symbol.for("react.activity"), b = Symbol.for("react.client.reference"), R = g.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, E = Object.prototype.hasOwnProperty, P = Array.isArray, k = console.createTask ? console.createTask : function() {
      return null;
    };
    g = {
    ...
    var S, M = {}, U = g.react_stack_bottom_frame.bind(
      g,
      i
    )(), F = k(r(i)), D = {};
    Zn.Fragment = v, Zn.jsx = function(x, B, H) {
...
var Xl = typeof global == "object" && global && global.Object === Object && global, Jc = typeof self == "object" && self && self.Object === Object && self, mt = Xl || Jc || Function("return this")(), Pt = mt.Symbol, Ql = Object.prototype, Yc = Ql.hasOwnProperty, Xc = Ql.toString, Jn = Pt ? Pt.toStringTag : void 0;
function Qc(n) {
...
var ai = mt["__core-js_shared__"], Lo = (function() {
...
var Si = nn(mt, "WeakMap"), qo = Object.create, Eu = /* @__PURE__ */ (function() {
  function n() {
  }
  return function(e) {
    if (!Mt(e))
...
var sa = Object.prototype, Ku = sa.hasOwnProperty, Vu = sa.propertyIsEnumerable, _i = ko(/* @__PURE__ */ (function() {
  ...
  return xt(n) && Ku.call(n, "callee") && !Vu.call(n, "callee");
};
function Gu() {
  return !1;
}
var ia = typeof exports == "object" && exports && !exports.nodeType && exports, jo = ia && typeof module == "object" && module && !module.nodeType && module, Wu = jo && jo.exports === ia, Bo = Wu ? mt.Buffer : void 0, Zu = Bo ? Bo.isBuffer : void 0, ar = Zu || Gu, Ju = "[object Arguments]", Yu = "[object Array]", Xu = "[object Boolean]", Qu = "[object Date]", eh = "[object Error]", th = "[object Function]", nh = "[object Map]", rh = "[object Number]", sh = "[object Object]", ih = "[object RegExp]", oh = "[object Set]", lh = "[object String]", ah = "[object WeakMap]", ch = "[object ArrayBuffer]", uh = "[object DataView]", hh = "[object Float32Array]", fh = "[object Float64Array]", dh = "[object Int8Array]", ph = "[object Int16Array]", mh = "[object Int32Array]", gh = "[object Uint8Array]", bh = "[object Uint8ClampedArray]", yh = "[object Uint16Array]", vh = "[object Uint32Array]", be = {};
...
function wh(n) {
  return xt(n) && ra(n.length) && !!be[In(n)];
}
function ro(n) {
  return function(e) {
    return n(e);
...
var Th = aa(Object.keys, Object), Ah = Object.prototype, Sh = Ah.hasOwnProperty;
function _h(n) {
  if (!no(n))
    return Th(n);
  var e = [];
...
At.prototype.clear = zh;
At.prototype.delete = Gh;
At.prototype.get = Wh;
At.prototype.has = Zh;
At.prototype.set = Jh;
var ur = nn(mt, "Map");
...
ht.prototype.clear = hf;
ht.prototype.delete = ff;
ht.prototype.get = df;
ht.prototype.has = pf;
ht.prototype.set = gf;
var fa = typeof exports == "object" && exports && !exports.nodeType && exports, Mo = fa && typeof module == "object" && module && !module.nodeType && module, bf = Mo && Mo.exports === fa, Do = bf ? mt.Buffer : void 0, Uo = Do ? Do.allocUnsafe : void 0;
function da(n, e) {
  if (e)
    return n.slice();
...
var Ci = nn(mt, "DataView"), Ri = nn(mt, "Promise"), Li = nn(mt, "Set"), Fo = "[object Map]", Tf = "[object Object]", Ho = "[object Promise]", zo = "[object Set]", Ko = "[object WeakMap]", Vo = "[object DataView]", Af = tn(Ci), Sf = tn(ur), _f = tn(Ri), Of = tn(Li), Cf = tn(Si), Xe = In;
(Ci && Xe(new Ci(new ArrayBuffer(1))) != Vo || ur && Xe(new ur()) != Fo || Ri && Xe(Ri.resolve()) != Ho || Li && Xe(new Li()) != zo || Si && Xe(new Si()) != Ko) && (Xe = function(n) {
  var e = In(n), t = e == Tf ? n.constructor : void 0, r = t ? tn(t) : "";
  if (r)
    switch (r) {
      case Af:
        return Vo;
...
var Jo = _n && _n.isSet, ad = Jo ? ro(Jo) : ld, cd = 1, ga = "[object Arguments]", ud = "[object Array]", hd = "[object Boolean]", fd = "[object Date]", dd = "[object Error]", ba = "[object Function]", pd = "[object GeneratorFunction]", md = "[object Map]", gd = "[object Number]", ya = "[object Object]", bd = "[object RegExp]", yd = "[object Set]", vd = "[object String]", wd = "[object Symbol]", Ed = "[object WeakMap]", xd = "[object ArrayBuffer]", Nd = "[object DataView]", Td = "[object Float32Array]", Ad = "[object Float64Array]", Sd = "[object Int8Array]", _d = "[object Int16Array]", Od = "[object Int32Array]", Cd = "[object Uint8Array]", Rd = "[object Uint8ClampedArray]", Ld = "[object Uint16Array]", qd = "[object Uint32Array]", de = {};
de[ga] = de[ud] = de[xd] = de[Nd] = de[hd] = de[fd] = de[Td] = de[Ad] = de[Sd] = de[_d] = de[Od] = de[md] = de[gd] = de[ya] = de[bd] = de[yd] = de[vd] = de[wd] = de[Cd] = de[Rd] = de[Ld] = de[qd] = !0;
de[dd] = de[ba] = de[Ed] = !1;
function es(n, e, t, r, s, i) {
  ...
  }) : id(n) && n.forEach(function(p, w) {
    o.set(w, es(p, e, t, w, n, i));
  });
  var d = Oi, g = c ? void 0 : d(n);
  return Lu(g || n, function(p, w) {
    g && (w = p, p = n[w]), na(o, w, es(p, e, t, w, n, i));
  }), o;
}
var Id = 1, kd = 4;
function Tn(n) {
...
function va(n, e, t, r, s, i) {
  ...
  if (u && f)
    return u == e && f == n;
  var m = -1, d = !0, g = t & $d ? new as() : void 0;
  for (i.set(n, e), i.set(e, n); ++m < a; ) {
    var p = n[m], w = e[m];
    if (r)
      var v = o ? r(w, p, m, e, n, i) : r(p, w, m, n, e, i);
    if (v !== void 0) {
      if (v)
        continue;
      d = !1;
    ...
    if (g) {
      if (!Md(e, function(N, C) {
        if (!Dd(g, C) && (p === N || s(p, N, t, r, i)))
          return g.push(C);
      })) {
        d = !1;
        break;
      }
    } else if (!(p === w || s(p, w, t, r, i))) {
      d = !1;
      break;
    }
  }
...
function lp(n, e, t, r, s, i) {
  ...
  for (var v = o; ++m < c; ) {
    ...
    var N = n[d], C = e[d];
    if (r)
      var L = o ? r(C, N, d, e, n, i) : r(N, C, d, n, e, i);
    if (!(L === void 0 ? N === C || s(N, C, t, r, i) : L)) {
      w = !1;
      break;
    }
    v || (v = d == "constructor");
  ...
  if (w && !v) {
    var q = n.constructor, j = e.constructor;
    q != j && "constructor" in n && "constructor" in e && !(typeof q == "function" && q instanceof q && typeof j == "function" && j instanceof j) && (w = !1);
  }
  return i.delete(n), i.delete(e), w;
}
...
function up(n, e, t, r, s, i) {
  ...
  if (d && !f)
    return i || (i = new ht()), o || so(n) ? va(n, e, t, r, s, i) : rp(n, e, c, t, r, s, i);
  if (!(t & ap)) {
    var g = f && el.call(n, "__wrapped__"), p = m && el.call(e, "__wrapped__");
    if (g || p) {
      var w = g ? n.value() : n, v = p ? e.value() : e;
      return i || (i = new ht()), s(w, v, t, r, i);
    }
  }
  return d ? (i || (i = new ht()), lp(n, e, t, r, s, i)) : !1;
}
function wa(n, e, t, r, s) {
  return n === e ? !0 : n == null || e == null || !xt(n) && !xt(e) ? n !== n && e !== e : up(n, e, t, r, wa, s);
}
function hp(n) {
...
function mp(n, e, t, r, s, i, o) {
  ...
  if (m) {
    var d = Yt(c), g = !d && ar(c), p = !d && !g && so(c);
    f = c, d || g || p ? Yt(a) ? f = a : dp(a) ? f = Nu(a) : g ? (m = !1, f = da(c, !0)) : p ? (m = !1, f = pa(c, !0)) : f = [] : uf(c) || _i(c) ? (f = a, _i(a) ? f = pp(a) : (!Mt(a) || eo(a)) && (f = ma(c))) : m = !1;
  }
...
class yp {
  ...
  build() {
    ...
    if (e == null)
      return;
    const t = dt.keys(this.domNode), r = nt.keys(this.domNode), s = Dt.keys(this.domNode);
    t.concat(r).concat(s).forEach((i) => {
      const o = e.scroll.query(i, Y.ATTRIBUTE);
      o instanceof dt && (this.attributes[o.attrName] = o);
    });
  }
  copy(e) {
...
const bn = class yn extends et {
  ...
  format(e, t) {
    if (e === this.statics.blotName && !t)
      ...
      if (r == null)
        return;
      r instanceof dt ? this.attributes.attribute(r, t) : t && (e !== this.statics.blotName || this.formats()[e] !== t) && this.replaceWith(e, t);
    }
  }
  formats() {
...
const lo = Np, vn = class ji extends et {
  ...
  format(e, t) {
    ...
    r != null && (r instanceof dt ? this.attributes.attribute(r, t) : e === this.statics.blotName && !t ? this.replaceWith(ji.blotName) : t && (e !== this.statics.blotName || this.formats()[e] !== t) && this.replaceWith(e, t));
  }
  formats() {
    const e = this.attributes.values(), t = this.statics.formats(this.domNode, this.scroll);
    return t != null && (e[this.statics.blotName] = t), e;
...
let Tp = vn;
const hr = Tp, Bi = class extends et {
  checkMerge() {
    ...
    for (let c = 0; a.length > 0; c += 1) {
      ...
      for (a.forEach((u) => {
        ...
        f != null && (f.domNode === u.target && (u.type === "childList" ? (i(this.find(u.previousSibling, !1)), Array.from(u.addedNodes).forEach((m) => {
          ...
          i(d, !1), d instanceof et && d.children.forEach((g) => {
            i(g, !1);
          });
...
function qp() {
  ...
  function r(b, R, E, P, k) {
    ...
    var M = a(b, R), U = b.substring(0, M);
    b = b.substring(M), R = R.substring(M), M = u(b, R);
    var F = b.substring(b.length - M);
    b = b.substring(0, b.length - M), R = R.substring(0, R.length - M);
    var D = s(b, R);
    return U && D.unshift([t, U]), F && D.push([t, F]), C(D, k), P && m(D), D;
  }
  function s(b, R) {
    var E;
    if (!b)
    ...
    if (!R)
      return [[n, b]];
    var P = b.length > R.length ? b : R, k = b.length > R.length ? R : b, S = P.indexOf(k);
    if (S !== -1)
      return E = [
        [e, P.substring(0, S)],
        [t, k],
        [e, P.substring(S + k.length)]
      ], b.length > R.length && (E[0][0] = E[2][0] = n), E;
    if (k.length === 1)
      return [
        [n, b],
        [e, R]
    ...
    var M = f(b, R);
    if (M) {
      var U = M[0], F = M[1], D = M[2], x = M[3], B = M[4], H = r(U, D), I = r(F, x);
      return H.concat([[t, B]], I);
    }
    return i(b, R);
  }
  function i(b, R) {
    for (var E = b.length, P = R.length, k = Math.ceil((E + P) / 2), S = k, M = 2 * k, U = new Array(M), F = new Array(M), D = 0; D < M; D++)
      U[D] = -1, F[D] = -1;
    U[S + 1] = 0, F[S + 1] = 0;
    for (var x = E - P, B = x % 2 !== 0, H = 0, I = 0, K = 0, ue = 0, Q = 0; Q < k; Q++) {
      for (var W = -Q + H; W <= Q - I; W += 2) {
        var te = S + W, Z;
        W === -Q || W !== Q && U[te - 1] < U[te + 1] ? Z = U[te + 1] : Z = U[te - 1] + 1;
        for (var re = Z - W; Z < E && re < P && b.charAt(Z) === R.charAt(re); )
          Z++, re++;
        if (U[te] = Z, Z > E)
          I += 2;
        else if (re > P)
      ...
      for (var me = -Q + K; me <= Q - ue; me += 2) {
        var le = S + me, ae;
        me === -Q || me !== Q && F[le - 1] < F[le + 1] ? ae = F[le + 1] : ae = F[le - 1] + 1;
        for (var ve = ae - me; ae < E && ve < P && b.charAt(E - ae - 1) === R.charAt(P - ve - 1); )
          ae++, ve++;
        if (F[le] = ae, ae > E)
          ue += 2;
        else if (ve > P)
  ...
  function o(b, R, E, P) {
    var k = b.substring(0, E), S = R.substring(0, P), M = b.substring(E), U = R.substring(P), F = r(k, S), D = r(M, U);
    return F.concat(D);
  }
  function a(b, R) {
    if (!b || !R || b.charAt(0) !== R.charAt(0))
      return 0;
    for (var E = 0, P = Math.min(b.length, R.length), k = P, S = 0; E < k; )
      b.substring(S, k) == R.substring(S, k) ? (E = k, S = E) : P = k, k = Math.floor((P - E) / 2 + E);
    return L(b.charCodeAt(k - 1)) && k--, k;
  }
  function c(b, R) {
    var E = b.length, P = R.length;
    if (E == 0 || P == 0)
      return 0;
    E > P ? b = b.substring(E - P) : E < P && (R = R.substring(0, E));
    var k = Math.min(E, P);
    if (b == R)
      return k;
    for (var S = 0, M = 1; ; ) {
      var U = b.substring(k - M), F = R.indexOf(U);
      if (F == -1)
        return S;
      M += F, (F == 0 || b.substring(k - M) == R.substring(0, M)) && (S = M, M++);
    }
  }
  function u(b, R) {
    if (!b || !R || b.slice(-1) !== R.slice(-1))
      return 0;
    for (var E = 0, P = Math.min(b.length, R.length), k = P, S = 0; E < k; )
      b.substring(b.length - k, b.length - S) == R.substring(R.length - k, R.length - S) ? (E = k, S = E) : P = k, k = Math.floor((P - E) / 2 + E);
    return q(b.charCodeAt(b.length - k)) && k--, k;
  }
  function f(b, R) {
    var E = b.length > R.length ? b : R, P = b.length > R.length ? R : b;
    if (E.length < 4 || P.length * 2 < E.length)
      return null;
    function k(I, K, ue) {
      for (var Q = I.substring(ue, ue + Math.floor(I.length / 4)), W = -1, te = "", Z, re, le, ae; (W = K.indexOf(Q, W + 1)) !== -1; ) {
        var me = a(
          I.substring(ue),
          K.substring(W)
        ), ve = u(
        ...
        te.length < ve + me && (te = K.substring(W - ve, W) + K.substring(W, W + me), Z = I.substring(0, ue - ve), re = I.substring(ue + me), le = K.substring(0, W - ve), ae = K.substring(W + me));
      }
      return te.length * 2 >= I.length ? [
        Z,
        re,
        le,
        ae,
    ...
    if (!S && !M)
      return null;
    M ? S ? U = S[4].length > M[4].length ? S : M : U = M : U = S;
    var F, D, x, B;
    b.length > R.length ? (F = U[0], D = U[1], x = U[2], B = U[3]) : (x = U[0], B = U[1], F = U[2], D = U[3]);
    var H = U[4];
    return [F, D, x, B, H];
  }
  function m(b) {
    for (var R = !1, E = [], P = 0, k = null, S = 0, M = 0, U = 0, F = 0, D = 0; S < b.length; )
      b[S][0] == t ? (E[P++] = S, M = F, U = D, F = 0, D = 0, k = b[S][1]) : (b[S][0] == e ? F += b[S][1].length : D += b[S][1].length, k && k.length <= Math.max(M, U) && k.length <= Math.max(F, D) && (b.splice(E[P - 1], 0, [
        n,
        k
      ]), b[E[P - 1] + 1][0] = e, P--, P--, S = P > 0 ? E[P - 1] : -1, M = 0, U = 0, F = 0, D = 0, k = null, R = !0)), S++;
    for (R && C(b), N(b), S = 1; S < b.length; ) {
      if (b[S - 1][0] == n && b[S][0] == e) {
        var x = b[S - 1][1], B = b[S][1], H = c(x, B), I = c(B, x);
        H >= I ? (H >= x.length / 2 || H >= B.length / 2) && (b.splice(S, 0, [
          t,
          B.substring(0, H)
        ]), b[S - 1][1] = x.substring(
          0,
          x.length - H
        ), b[S + 1][1] = B.substring(H), S++) : (I >= x.length / 2 || I >= B.length / 2) && (b.splice(S, 0, [
          t,
          x.substring(0, I)
        ]), b[S - 1][0] = e, b[S - 1][1] = B.substring(
          0,
          B.length - I
        ), b[S + 1][0] = n, b[S + 1][1] = x.substring(I), S++), S++;
      }
      S++;
    }
  }
  var d = /[^a-zA-Z0-9]/, g = /\s/, p = /[\r\n]/, w = /\n\r?\n$/, v = /^\r?\n\r?\n/;
  function N(b) {
    function R(I, K) {
      if (!I || !K)
        return 6;
      var ue = I.charAt(I.length - 1), Q = K.charAt(0), W = ue.match(d), te = Q.match(d), Z = W && ue.match(g), re = te && Q.match(g), le = Z && ue.match(p), ae = re && Q.match(p), me = le && I.match(w), ve = ae && K.match(v);
      return me || ve ? 5 : le || ae ? 4 : W && !Z && re ? 3 : Z || re ? 2 : W || te ? 1 : 0;
    }
    for (var E = 1; E < b.length - 1; ) {
      if (b[E - 1][0] == t && b[E + 1][0] == t) {
        var P = b[E - 1][1], k = b[E][1], S = b[E + 1][1], M = u(P, k);
        if (M) {
          var U = k.substring(k.length - M);
          P = P.substring(0, P.length - M), k = U + k.substring(0, k.length - M), S = U + S;
        }
        for (var F = P, D = k, x = S, B = R(P, k) + R(k, S); k.charAt(0) === S.charAt(0); ) {
          P += k.charAt(0), k = k.substring(1) + S.charAt(0), S = S.substring(1);
          var H = R(P, k) + R(k, S);
          H >= B && (B = H, F = P, D = k, x = S);
        }
        b[E - 1][1] != F && (F ? b[E - 1][1] = F : (b.splice(E - 1, 1), E--), b[E][1] = D, x ? b[E + 1][1] = x : (b.splice(E + 1, 1), E--));
      }
      E++;
    }
  }
  function C(b, R) {
    b.push([t, ""]);
    for (var E = 0, P = 0, k = 0, S = "", M = "", U; E < b.length; ) {
      if (E < b.length - 1 && !b[E][1]) {
        b.splice(E, 1);
        continue;
      }
      switch (b[E][0]) {
        ...
        case t:
          ...
          if (R) {
            if (F >= 0 && G(b[F][1])) {
              var D = b[F][1].slice(-1);
              if (b[F][1] = b[F][1].slice(
                0,
                -1
              ), S = D + S, M = D + M, !b[F][1]) {
                b.splice(F, 1), E--;
                var x = F - 1;
                b[x] && b[x][0] === e && (k++, M = b[x][1] + M, x--), b[x] && b[x][0] === n && (P++, S = b[x][1] + S, x--), F = x;
              }
            }
            if (j(b[E][1])) {
              var D = b[E][1].charAt(0);
              b[E][1] = b[E][1].slice(1), S += D, M += D;
            }
          }
          if (E < b.length - 1 && !b[E][1]) {
            b.splice(E, 1);
          ...
          if (S.length > 0 || M.length > 0) {
            S.length > 0 && M.length > 0 && (U = a(M, S), U !== 0 && (F >= 0 ? b[F][1] += M.substring(
              0,
              U
            ) : (b.splice(0, 0, [
              t,
              M.substring(0, U)
            ]), E++), M = M.substring(U), S = S.substring(U)), U = u(M, S), U !== 0 && (b[E][1] = M.substring(M.length - U) + b[E][1], M = M.substring(
              0,
              M.length - U
            ), S = S.substring(
              0,
            ...
            var B = k + P;
            S.length === 0 && M.length === 0 ? (b.splice(E - B, B), E = E - B) : S.length === 0 ? (b.splice(E - B, B, [e, M]), E = E - B + 1) : M.length === 0 ? (b.splice(E - B, B, [n, S]), E = E - B + 1) : (b.splice(
              E - B,
              B,
              [n, S],
              [e, M]
          ...
          E !== 0 && b[E - 1][0] === t ? (b[E - 1][1] += b[E][1], b.splice(E, 1)) : E++, k = 0, P = 0, S = "", M = "";
          break;
      }
    }
    b[b.length - 1][1] === "" && b.pop();
    var H = !1;
    for (E = 1; E < b.length - 1; )
      b[E - 1][0] === t && b[E + 1][0] === t && (b[E][1].substring(
        b[E][1].length - b[E - 1][1].length
      ) === b[E - 1][1] ? (b[E][1] = b[E - 1][1] + b[E][1].substring(
        0,
        b[E][1].length - b[E - 1][1].length
      ), b[E + 1][1] = b[E - 1][1] + b[E + 1][1], b.splice(E - 1, 1), H = !0) : b[E][1].substring(0, b[E + 1][1].length) == b[E + 1][1] && (b[E - 1][1] += b[E + 1][1], b[E][1] = b[E][1].substring(b[E + 1][1].length) + b[E + 1][1], b.splice(E + 1, 1), H = !0)), E++;
    H && C(b, R);
  }
  function L(b) {
  ...
  function G(b) {
    return L(b.charCodeAt(b.length - 1));
  }
  function z(b) {
    for (var R = [], E = 0; E < b.length; E++)
      b[E][1].length > 0 && R.push(b[E]);
    return R;
  }
  function ie(b, R, E, P) {
    return G(b) || j(P) ? null : z([
      [t, b],
      [n, R],
      [e, E],
      [t, P]
  ...
  function oe(b, R, E) {
    var P = typeof E == "number" ? { index: E, length: 0 } : E.oldRange, k = typeof E == "number" ? null : E.newRange, S = b.length, M = R.length;
    if (P.length === 0 && (k === null || k.length === 0)) {
      var U = P.index, F = b.slice(0, U), D = b.slice(U), x = k ? k.index : null;
      e: {
        var B = U + M - S;
        if (x !== null && x !== B || B < 0 || B > M)
          break e;
        var H = R.slice(0, B), I = R.slice(B);
        if (I !== D)
          break e;
        var K = Math.min(U, B), ue = F.slice(0, K), Q = H.slice(0, K);
        if (ue !== Q)
          break e;
        var W = F.slice(K), te = H.slice(K);
        return ie(ue, W, te, D);
      }
      e: {
        if (x !== null && x !== U)
          break e;
        var Z = U, H = R.slice(0, Z), I = R.slice(Z);
        if (H !== F)
          break e;
        var re = Math.min(S - Z, M - Z), le = D.slice(D.length - re), ae = I.slice(I.length - re);
        if (le !== ae)
          break e;
        var W = D.slice(0, D.length - re), te = I.slice(0, I.length - re);
        return ie(F, W, te, le);
      }
    }
    if (P.length > 0 && k && k.length === 0)
      e: {
        var ue = b.slice(0, P.index), le = b.slice(P.index + P.length), K = ue.length, re = le.length;
        if (M < K + re)
          break e;
        var Q = R.slice(0, K), ae = R.slice(M - re);
        if (ue !== Q || le !== ae)
          break e;
        var W = b.slice(K, S - re), te = R.slice(K, M - re);
        return ie(ue, W, te, le);
      }
    return null;
  }
  function pe(b, R, E, P) {
  ...
  return pe.INSERT = e, pe.DELETE = n, pe.EQUAL = t, fi = pe, fi;
}
var er = { exports: {} };
er.exports;
var sl;
function Oa() {
  return sl || (sl = 1, (function(n, e) {
    var t = 200, r = "__lodash_hash_undefined__", s = 9007199254740991, i = "[object Arguments]", o = "[object Array]", a = "[object Boolean]", c = "[object Date]", u = "[object Error]", f = "[object Function]", m = "[object GeneratorFunction]", d = "[object Map]", g = "[object Number]", p = "[object Object]", w = "[object Promise]", v = "[object RegExp]", N = "[object Set]", C = "[object String]", L = "[object Symbol]", q = "[object WeakMap]", j = "[object ArrayBuffer]", G = "[object DataView]", z = "[object Float32Array]", ie = "[object Float64Array]", oe = "[object Int8Array]", pe = "[object Int16Array]", b = "[object Int32Array]", R = "[object Uint8Array]", E = "[object Uint8ClampedArray]", P = "[object Uint16Array]", k = "[object Uint32Array]", S = /[\\^$.*+?()[\]{}|]/g, M = /\w*$/, U = /^\[object .+?Constructor\]$/, F = /^(?:0|[1-9]\d*)$/, D = {};
    D[i] = D[o] = D[j] = D[G] = D[a] = D[c] = D[z] = D[ie] = D[oe] = D[pe] = D[b] = D[d] = D[g] = D[p] = D[v] = D[N] = D[C] = D[L] = D[R] = D[E] = D[P] = D[k] = !0, D[u] = D[f] = D[q] = !1;
    var x = typeof It == "object" && It && It.Object === Object && It, B = typeof self == "object" && self && self.Object === Object && self, H = x || B || Function("return this")(), I = e && !e.nodeType && e, K = I && !0 && n && !n.nodeType && n, ue = K && K.exports === I;
    function Q(l, h) {
    ...
    function te(l, h) {
      for (var y = -1, A = l ? l.length : 0; ++y < A && h(l[y], y, l) !== !1; )
        ;
      return l;
    }
    function Z(l, h) {
      for (var y = -1, A = h.length, se = l.length; ++y < A; )
        l[se + y] = h[y];
      return l;
    }
    function re(l, h, y, A) {
      for (var se = -1, X = l ? l.length : 0; ++se < X; )
        y = h(y, l[se], se, l);
      return y;
    }
    function le(l, h) {
      for (var y = -1, A = Array(l); ++y < l; )
        A[y] = h(y);
      return A;
    }
    function ae(l, h) {
    ...
    function ve(l) {
      var h = -1, y = Array(l.size);
      return l.forEach(function(A, se) {
        y[++h] = [se, A];
      }), y;
    }
    function De(l, h) {
    ...
    var Ut = Array.prototype, _t = Function.prototype, ne = Object.prototype, Ot = H["__core-js_shared__"], $t = (function() {
      var l = /[^.]+$/.exec(Ot && Ot.keys && Ot.keys.IE_PROTO || "");
      return l ? "Symbol(src)_1." + l : "";
    })(), Ft = _t.toString, Pe = ne.hasOwnProperty, gt = ne.toString, an = RegExp(
      "^" + Ft.call(Pe).replace(S, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
    ), ot = ue ? H.Buffer : void 0, ge = H.Symbol, Ct = H.Uint8Array, Ue = De(Object.getPrototypeOf, Object), Ar = Object.create, Sr = ne.propertyIsEnumerable, Ts = Ut.splice, jn = Object.getOwnPropertySymbols, cn = ot ? ot.isBuffer : void 0, _r = De(Object.keys, Object), un = Ze(H, "DataView"), Ht = Ze(H, "Map"), We = Ze(H, "Promise"), hn = Ze(H, "Set"), Bn = Ze(H, "WeakMap"), zt = Ze(Object, "create"), Pn = qe(un), Kt = qe(Ht), Mn = qe(We), Dn = qe(hn), Un = qe(Bn), Rt = ge ? ge.prototype : void 0, Or = Rt ? Rt.valueOf : void 0;
    function bt(l) {
      var h = -1, y = l ? l.length : 0;
      for (this.clear(); ++h < y; ) {
        var A = l[h];
        this.set(A[0], A[1]);
      }
    ...
    function $n(l, h) {
      var y = this.__data__;
      return y[l] = zt && h === void 0 ? r : h, this;
    }
    bt.prototype.clear = As, bt.prototype.delete = Ss, bt.prototype.get = _s, bt.prototype.has = Cr, bt.prototype.set = $n;
    function xe(l) {
      var h = -1, y = l ? l.length : 0;
      for (this.clear(); ++h < y; ) {
        var A = l[h];
    ...
    function Cs(l) {
      var h = this.__data__, y = dn(h, l);
      if (y < 0)
        return !1;
      var A = h.length - 1;
      return y == A ? h.pop() : Ts.call(h, y, 1), !0;
    }
    function Rs(l) {
      var h = this.__data__, y = dn(h, l);
      return y < 0 ? void 0 : h[y][1];
    }
    function Ls(l) {
      return dn(this.__data__, l) > -1;
    }
    function qs(l, h) {
      var y = this.__data__, A = dn(y, l);
      return A < 0 ? y.push([l, h]) : y[A][1] = h, this;
    }
    ...
    Ae.prototype.clear = Is, Ae.prototype.delete = ks, Ae.prototype.get = js, Ae.prototype.has = Bs, Ae.prototype.set = Ps;
    function Ie(l) {
    ...
    function Fs(l, h) {
      ...
      if (y instanceof xe) {
        var A = y.__data__;
        if (!Ht || A.length < t - 1)
          return A.push([l, h]), this;
        y = this.__data__ = new Ae(A);
      }
      return y.set(l, h), this;
    }
    Ie.prototype.clear = Ms, Ie.prototype.delete = Ds, Ie.prototype.get = Us, Ie.prototype.has = $s, Ie.prototype.set = Fs;
    function fn(l, h) {
      var y = Kn(l) || mn(l) ? le(l.length, String) : [], A = y.length, se = !!A;
      for (var X in l)
        Pe.call(l, X) && !(se && (X == "length" || ni(X, A))) && y.push(X);
      return y;
    }
    function Rr(l, h, y) {
      var A = l[h];
      (!(Pe.call(l, h) && jr(A, y)) || y === void 0 && !(h in l)) && (l[h] = y);
    }
    function dn(l, h) {
    ...
    function Fn(l, h, y, A, se, X, he) {
      var ce;
      if (A && (ce = X ? A(l, se, X, he) : A(l)), ce !== void 0)
        return ce;
      if (!ct(l))
        return l;
      var we = Kn(l);
      ...
      return te(Ee || l, function(_e, Ne) {
        Ee && (Ne = _e, _e = l[Ne]), Rr(ce, Ne, Fn(_e, h, y, A, Ne, l, he));
      }), ce;
    }
    function Hs(l) {
      return ct(l) ? Ar(l) : {};
    ...
    function Gs(l) {
      ...
      for (var y in Object(l))
        Pe.call(l, y) && y != "constructor" && h.push(y);
      return h;
    }
    function pn(l, h) {
      if (h)
        return l.slice();
      var y = new l.constructor(l.length);
      return l.copy(y), y;
    }
    function Hn(l) {
    ...
    function Vt(l, h) {
      var y = h ? Hn(l.buffer) : l.buffer;
      return new l.constructor(y, l.byteOffset, l.byteLength);
    }
    function Lr(l, h, y) {
      var A = h ? y(ve(l), !0) : ve(l);
      return re(A, Q, new l.constructor());
    }
    function qr(l) {
      var h = new l.constructor(l.source, M.exec(l));
      return h.lastIndex = l.lastIndex, h;
    }
    function Ws(l, h, y) {
      var A = h ? y(Ge(l), !0) : Ge(l);
      return re(A, W, new l.constructor());
    }
    function Zs(l) {
    ...
    function zn(l, h, y, A) {
      y || (y = {});
      for (var se = -1, X = h.length; ++se < X; ) {
        var he = h[se], ce = void 0;
        Rr(y, he, ce === void 0 ? l[he] : ce);
      }
      return y;
    }
    function Xs(l, h) {
    ...
    function Gt(l, h) {
      var y = l.__data__;
      return ri(h) ? y[typeof h == "string" ? "string" : "hash"] : y.map;
    }
    function Ze(l, h) {
      var y = ae(l, h);
      return Vs(y) ? y : void 0;
    }
    var yt = jn ? De(jn, Object) : oi, vt = Ks;
    (un && vt(new un(new ArrayBuffer(1))) != G || Ht && vt(new Ht()) != d || We && vt(We.resolve()) != w || hn && vt(new hn()) != N || Bn && vt(new Bn()) != q) && (vt = function(l) {
      var h = gt.call(l), y = h == p ? l.constructor : void 0, A = y ? qe(y) : void 0;
      if (A)
        switch (A) {
          case Pn:
            return G;
    ...
    function ei(l) {
      var h = l.length, y = l.constructor(h);
      return h && typeof l[0] == "string" && Pe.call(l, "index") && (y.index = l.index, y.input = l.input), y;
    }
    function at(l) {
      return typeof l.constructor == "function" && !Ir(l) ? Hs(Ue(l)) : {};
    }
    function ti(l, h, y, A) {
      var se = l.constructor;
      switch (h) {
        case j:
          return Hn(l);
        case a:
    ...
    function Ir(l) {
      var h = l && l.constructor, y = typeof h == "function" && h.prototype || ne;
      return l === y;
    }
    function qe(l) {
      if (l != null) {
    ...
    function mn(l) {
      return ii(l) && Pe.call(l, "callee") && (!Sr.call(l, "callee") || gt.call(l) == i);
    }
...
function Ca() {
  return il || (il = 1, (function(n, e) {
    var t = 200, r = "__lodash_hash_undefined__", s = 1, i = 2, o = 9007199254740991, a = "[object Arguments]", c = "[object Array]", u = "[object AsyncFunction]", f = "[object Boolean]", m = "[object Date]", d = "[object Error]", g = "[object Function]", p = "[object GeneratorFunction]", w = "[object Map]", v = "[object Number]", N = "[object Null]", C = "[object Object]", L = "[object Promise]", q = "[object Proxy]", j = "[object RegExp]", G = "[object Set]", z = "[object String]", ie = "[object Symbol]", oe = "[object Undefined]", pe = "[object WeakMap]", b = "[object ArrayBuffer]", R = "[object DataView]", E = "[object Float32Array]", P = "[object Float64Array]", k = "[object Int8Array]", S = "[object Int16Array]", M = "[object Int32Array]", U = "[object Uint8Array]", F = "[object Uint8ClampedArray]", D = "[object Uint16Array]", x = "[object Uint32Array]", B = /[\\^$.*+?()[\]{}|]/g, H = /^\[object .+?Constructor\]$/, I = /^(?:0|[1-9]\d*)$/, K = {};
    K[E] = K[P] = K[k] = K[S] = K[M] = K[U] = K[F] = K[D] = K[x] = !0, K[a] = K[c] = K[b] = K[f] = K[R] = K[m] = K[d] = K[g] = K[w] = K[v] = K[C] = K[j] = K[G] = K[z] = K[pe] = !1;
    var ue = typeof It == "object" && It && It.Object === Object && It, Q = typeof self == "object" && self && self.Object === Object && self, W = ue || Q || Function("return this")(), te = e && !e.nodeType && e, Z = te && !0 && n && !n.nodeType && n, re = Z && Z.exports === te, le = re && ue.process, ae = (function() {
      try {
    ...
    function ve(l, h) {
      for (var y = -1, A = l == null ? 0 : l.length, se = 0, X = []; ++y < A; ) {
        var he = l[y];
        h(he, y, l) && (X[se++] = he);
      }
      return X;
    ...
    function Ge(l, h) {
      for (var y = -1, A = l == null ? 0 : l.length; ++y < A; )
        if (h(l[y], y, l))
          return !0;
      return !1;
    }
    ...
    var gt = Array.prototype, an = Function.prototype, ot = Object.prototype, ge = W["__core-js_shared__"], Ct = an.toString, Ue = ot.hasOwnProperty, Ar = (function() {
      var l = /[^.]+$/.exec(ge && ge.keys && ge.keys.IE_PROTO || "");
      return l ? "Symbol(src)_1." + l : "";
    })(), Sr = ot.toString, Ts = RegExp(
      "^" + Ct.call(Ue).replace(B, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
    ), jn = re ? W.Buffer : void 0, cn = W.Symbol, _r = W.Uint8Array, un = ot.propertyIsEnumerable, Ht = gt.splice, We = cn ? cn.toStringTag : void 0, hn = Object.getOwnPropertySymbols, Bn = jn ? jn.isBuffer : void 0, zt = Ft(Object.keys, Object), Pn = yt(W, "DataView"), Kt = yt(W, "Map"), Mn = yt(W, "Promise"), Dn = yt(W, "Set"), Un = yt(W, "WeakMap"), Rt = yt(Object, "create"), Or = qe(Pn), bt = qe(Kt), As = qe(Mn), Ss = qe(Dn), _s = qe(Un), Cr = cn ? cn.prototype : void 0, $n = Cr ? Cr.valueOf : void 0;
    function xe(l) {
      var h = -1, y = l == null ? 0 : l.length;
      for (this.clear(); ++h < y; ) {
        var A = l[h];
        this.set(A[0], A[1]);
      }
    ...
    function Ls(l) {
      var h = this.__data__;
      return Rt ? h[l] !== void 0 : Ue.call(h, l);
    }
    function qs(l, h) {
      var y = this.__data__;
      return this.size += this.has(l) ? 0 : 1, y[l] = Rt && h === void 0 ? r : h, this;
    }
    xe.prototype.clear = Os, xe.prototype.delete = Cs, xe.prototype.get = Rs, xe.prototype.has = Ls, xe.prototype.set = qs;
    function Ae(l) {
      var h = -1, y = l == null ? 0 : l.length;
    ...
    function ks(l) {
      var h = this.__data__, y = pn(h, l);
      if (y < 0)
        return !1;
      var A = h.length - 1;
      return y == A ? h.pop() : Ht.call(h, y, 1), --this.size, !0;
    }
    function js(l) {
      var h = this.__data__, y = pn(h, l);
      return y < 0 ? void 0 : h[y][1];
    ...
    function Ps(l, h) {
      var y = this.__data__, A = pn(y, l);
      return A < 0 ? (++this.size, y.push([l, h])) : y[A][1] = h, this;
    }
    Ae.prototype.clear = Is, Ae.prototype.delete = ks, Ae.prototype.get = js, Ae.prototype.has = Bs, Ae.prototype.set = Ps;
    function Ie(l) {
      var h = -1, y = l == null ? 0 : l.length;
    ...
    function Fs(l, h) {
      var y = Ze(this, l), A = y.size;
      return y.set(l, h), this.size += y.size == A ? 0 : 1, this;
    }
    Ie.prototype.clear = Ms, Ie.prototype.delete = Ds, Ie.prototype.get = Us, Ie.prototype.has = $s, Ie.prototype.set = Fs;
    function fn(l) {
      var h = -1, y = l == null ? 0 : l.length;
      for (this.__data__ = new Ie(); ++h < y; )
        this.add(l[h]);
    }
    function Rr(l) {
    ...
    function Hs(l) {
      var h = this.__data__, y = h.delete(l);
    ...
    function Vs(l, h) {
      ...
      if (y instanceof Ae) {
        var A = y.__data__;
        if (!Kt || A.length < t - 1)
          return A.push([l, h]), this.size = ++y.size, this;
        y = this.__data__ = new Ie(A);
      }
      return y.set(l, h), this.size = y.size, this;
    }
    lt.prototype.clear = Fn, lt.prototype.delete = Hs, lt.prototype.get = zs, lt.prototype.has = Ks, lt.prototype.set = Vs;
    function Gs(l, h) {
      var y = mn(l), A = !y && jr(l), se = !y && !A && gn(l), X = !y && !A && !se && Mr(l), he = y || A || se || X, ce = he ? Ut(l.length, String) : [], we = ce.length;
      for (var fe in l)
        Ue.call(l, fe) && !(he && // Safari 9 has enumerable `arguments.length` in strict mode.
        (fe == "length" || // Node.js 0.10 has enumerable non-index properties on buffers.
        se && (fe == "offset" || fe == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
        X && (fe == "buffer" || fe == "byteLength" || fe == "byteOffset") || // Skip index properties.
        ti(fe, we))) && ce.push(fe);
      return ce;
    }
    function pn(l, h) {
    ...
    function Hn(l, h, y) {
      var A = h(l);
      return mn(l) ? A : De(A, y(l));
    }
    function Vt(l) {
      return l == null ? l === void 0 ? oe : N : We && We in Object(l) ? vt(l) : Ir(l);
    }
    function Lr(l) {
      return ct(l) && Vt(l) == a;
    }
    function qr(l, h, y, A, se) {
      return l === h ? !0 : l == null || h == null || !ct(l) && !ct(h) ? l !== l && h !== h : Ws(l, h, y, A, qr, se);
    }
    function Ws(l, h, y, A, se, X) {
      var he = mn(l), ce = mn(h), we = he ? c : at(l), fe = ce ? c : at(h);
      we = we == a ? C : we, fe = fe == a ? C : fe;
      var Se = we == C, ke = fe == C, Ee = we == fe;
      if (Ee && gn(l)) {
        if (!gn(h))
          return !1;
        he = !0, Se = !1;
      ...
      if (Ee && !Se)
        return X || (X = new lt()), he || Mr(l) ? zn(l, h, y, A, se, X) : Xs(l, h, we, y, A, se, X);
      if (!(y & s)) {
        var _e = Se && Ue.call(l, "__wrapped__"), Ne = ke && Ue.call(h, "__wrapped__");
        if (_e || Ne) {
          var Lt = _e ? l.value() : l, wt = Ne ? h.value() : h;
          return X || (X = new lt()), se(Lt, wt, y, A, X);
        }
      }
      return Ee ? (X || (X = new lt()), Qs(l, h, y, A, se, X)) : !1;
    }
    function Zs(l) {
      if (!Pr(l) || ri(l))
        return !1;
    ...
    function Js(l) {
      return ct(l) && Vn(l.length) && !!K[Vt(l)];
    }
    function Ys(l) {
      if (!si(l))
        return zt(l);
      var h = [];
      for (var y in Object(l))
        Ue.call(l, y) && y != "constructor" && h.push(y);
      return h;
    }
    function zn(l, h, y, A, se, X) {
      var he = y & s, ce = l.length, we = h.length;
      if (ce != we && !(he && we > ce))
        return !1;
      var fe = X.get(l);
      if (fe && X.get(h))
        return fe == h;
      var Se = -1, ke = !0, Ee = y & i ? new fn() : void 0;
      for (X.set(l, h), X.set(h, l); ++Se < ce; ) {
        var _e = l[Se], Ne = h[Se];
        if (A)
          var Lt = he ? A(Ne, _e, Se, h, l, X) : A(_e, Ne, Se, l, h, X);
        if (Lt !== void 0) {
          if (Lt)
            continue;
          ke = !1;
        ...
        if (Ee) {
          if (!Ge(h, function(wt, Wt) {
            if (!ne(Ee, Wt) && (_e === wt || se(_e, wt, y, A, X)))
              return Ee.push(Wt);
          })) {
            ke = !1;
            break;
          }
        } else if (!(_e === Ne || se(_e, Ne, y, A, X))) {
          ke = !1;
          break;
        }
      }
      return X.delete(l), X.delete(h), ke;
    }
    function Xs(l, h, y, A, se, X, he) {
      switch (y) {
        case R:
        ...
        case b:
          return !(l.byteLength != h.byteLength || !X(new _r(l), new _r(h)));
        case f:
        case m:
        case v:
          return kr(+l, +h);
        ...
        case G:
          var we = A & s;
          if (ce || (ce = Pe), l.size != h.size && !we)
            return !1;
          var fe = he.get(l);
          if (fe)
            return fe == h;
          A |= i, he.set(l, h);
          var Se = zn(ce(l), ce(h), A, se, X, he);
    ...
    function Qs(l, h, y, A, se, X) {
      var he = y & s, ce = Gt(l), we = ce.length, fe = Gt(h), Se = fe.length;
      if (we != Se && !he)
        return !1;
      for (var ke = we; ke--; ) {
        var Ee = ce[ke];
        if (!(he ? Ee in h : Ue.call(h, Ee)))
          return !1;
      }
      var _e = X.get(l);
      if (_e && X.get(h))
      ...
      for (var Lt = he; ++ke < we; ) {
        ...
        var wt = l[Ee], Wt = h[Ee];
        if (A)
          var So = he ? A(Wt, wt, Ee, h, l, X) : A(wt, Wt, Ee, l, h, X);
        if (!(So === void 0 ? wt === Wt || se(wt, Wt, y, A, X) : So)) {
          Ne = !1;
          break;
        }
      ...
      return X.delete(l), X.delete(h), Ne;
    }
    function Gt(l) {
      return Hn(l, Gn, ei);
    }
    function Ze(l, h) {
      var y = l.__data__;
      return ni(h) ? y[typeof h == "string" ? "string" : "hash"] : y.map;
    }
    function yt(l, h) {
      var y = Ot(l, h);
      return Zs(y) ? y : void 0;
    }
    function vt(l) {
      var h = Ue.call(l, We), y = l[We];
      try {
        l[We] = void 0;
        var A = !0;
      } catch {
      ...
      var se = Sr.call(l);
      return A && (h ? l[We] = y : delete l[We]), se;
    }
    ...
    (Pn && at(new Pn(new ArrayBuffer(1))) != R || Kt && at(new Kt()) != w || Mn && at(Mn.resolve()) != L || Dn && at(new Dn()) != G || Un && at(new Un()) != pe) && (at = function(l) {
      var h = Vt(l), y = h == C ? l.constructor : void 0, A = y ? qe(y) : "";
      if (A)
        switch (A) {
          case Or:
            return R;
    ...
    function ti(l, h) {
      return h = h ?? o, !!h && (typeof l == "number" || I.test(l)) && l > -1 && l % 1 == 0 && l < h;
    }
    function ni(l) {
      var h = typeof l;
      return h == "string" || h == "number" || h == "symbol" || h == "boolean" ? l !== "__proto__" : l === null;
    ...
    function si(l) {
      var h = l && l.constructor, y = typeof h == "function" && h.prototype || ot;
      return l === y;
    }
    function Ir(l) {
      return Sr.call(l);
    ...
    var jr = Lr(/* @__PURE__ */ (function() {
      ...
      return ct(l) && Ue.call(l, "callee") && !un.call(l, "callee");
    }, mn = Array.isArray;
    function Kn(l) {
...
function Ip() {
  ...
  return (function(r) {
    function s(c = {}, u = {}, f = !1) {
      ...
      let m = n(u);
      f || (m = Object.keys(m).reduce((d, g) => (m[g] != null && (d[g] = m[g]), d), {}));
      for (const d in c)
    ...
    function a(c, u, f = !1) {
      ...
      if (!f)
        return u;
      const m = Object.keys(u).reduce((d, g) => (c[g] === void 0 && (d[g] = u[g]), d), {});
      return Object.keys(m).length > 0 ? m : void 0;
    }
    r.transform = a;
  })(t || (t = {})), Kr.default = t, Kr;
...
function jp() {
  return cl || (cl = 1, (function(n, e) {
    ...
    class f {
      ...
      insert(d, g) {
        const p = {};
        return typeof d == "string" && d.length === 0 ? this : (p.insert = d, g != null && typeof g == "object" && Object.keys(g).length > 0 && (p.attributes = g), this.push(p));
      }
      delete(d) {
      ...
      push(d) {
        ...
        if (d = r(d), typeof p == "object") {
          if (typeof d.delete == "number" && typeof p.delete == "number")
            return this.ops[g - 1] = { delete: p.delete + d.delete }, this;
          if (typeof p.delete == "number" && d.insert != null && (g -= 1, p = this.ops[g - 1], typeof p != "object"))
            return this.ops.unshift(d), this;
          if (s(d.attributes, p.attributes)) {
            if (typeof d.insert == "string" && typeof p.insert == "string")
              return this.ops[g - 1] = { insert: p.insert + d.insert }, typeof d.attributes == "object" && (this.ops[g - 1].attributes = d.attributes), this;
            if (typeof d.retain == "number" && typeof p.retain == "number")
              return this.ops[g - 1] = { retain: p.retain + d.retain }, typeof d.attributes == "object" && (this.ops[g - 1].attributes = d.attributes), this;
          }
        }
      ...
      changeLength() {
        return this.reduce((d, g) => g.insert ? d + o.default.length(g) : g.delete ? d - g.delete : d, 0);
      }
      length() {
        return this.reduce((d, g) => d + o.default.length(g), 0);
      }
      slice(d = 0, g = 1 / 0) {
        const p = [], w = new a.default(this.ops);
        let v = 0;
        for (; v < g && w.hasNext(); ) {
          let N;
          v < d ? N = w.next(d - v) : (N = w.next(g - v), p.push(N)), v += o.default.length(N);
        }
        return new f(p);
      }
      compose(d) {
        const g = new a.default(this.ops), p = new a.default(d.ops), w = [], v = p.peek();
        if (v != null && typeof v.retain == "number" && v.attributes == null) {
          let C = v.retain;
          for (; g.peekType() === "insert" && g.peekLength() <= C; )
            C -= g.peekLength(), w.push(g.next());
          v.retain - C > 0 && p.next(v.retain - C);
        }
        const N = new f(w);
        for (; g.hasNext() || p.hasNext(); )
          if (p.peekType() === "insert")
            ...
            const C = Math.min(g.peekLength(), p.peekLength()), L = g.next(C), q = p.next(C);
            if (q.retain) {
              const j = {};
              if (typeof L.retain == "number")
                j.retain = typeof q.retain == "number" ? C : q.retain;
              else if (typeof q.retain == "number")
                L.retain == null ? j.insert = L.insert : j.retain = L.retain;
              else {
                const z = L.retain == null ? "insert" : "retain", [ie, oe, pe] = u(L[z], q.retain), b = f.getHandler(ie);
                j[z] = {
                  [ie]: b.compose(oe, pe, z === "retain")
                };
              }
              const G = i.default.compose(L.attributes, q.attributes, typeof L.retain == "number");
              if (G && (j.attributes = G), N.push(j), !p.hasNext() && s(N.ops[N.ops.length - 1], j)) {
                const z = new f(g.rest());
                return N.concat(z).chop();
              }
            } else typeof q.delete == "number" && (typeof L.retain == "number" || typeof L.retain == "object" && L.retain !== null) && N.push(q);
          }
        return N.chop();
      }
      concat(d) {
      ...
      diff(d, g) {
        if (this.ops === d.ops)
          return new f();
        const p = [this, d].map((L) => L.map((q) => {
          if (q.insert != null)
            return typeof q.insert == "string" ? q.insert : c;
          const j = L === d ? "on" : "with";
          throw new Error("diff() called " + j + " non-document");
        }).join("")), w = new f(), v = t(p[0], p[1], g, !0), N = new a.default(this.ops), C = new a.default(d.ops);
        return v.forEach((L) => {
          let q = L[1].length;
          for (; q > 0; ) {
            let j = 0;
            switch (L[0]) {
              case t.INSERT:
                j = Math.min(C.peekLength(), q), w.push(C.next(j));
                break;
              case t.DELETE:
                j = Math.min(q, N.peekLength()), N.next(j), w.delete(j);
                break;
              case t.EQUAL:
                j = Math.min(N.peekLength(), C.peekLength(), q);
                const G = N.next(j), z = C.next(j);
                s(G.insert, z.insert) ? w.retain(j, i.default.diff(G.attributes, z.attributes)) : w.push(z).delete(j);
                break;
            }
            q -= j;
          }
...
`) {
        ...
        for (; p.hasNext(); ) {
          if (p.peekType() !== "insert")
            return;
          const N = p.peek(), C = o.default.length(N) - p.peekLength(), L = typeof N.insert == "string" ? N.insert.indexOf(g, C) - C : -1;
          if (L < 0)
            w.push(p.next());
          else if (L > 0)
            w.push(p.next(L));
          else {
            if (d(w, p.next(1).attributes || {}, v) === !1)
              return;
            v += 1, w = new f();
          }
        }
      ...
      invert(d) {
        const g = new f();
        return this.reduce((p, w) => {
          if (w.insert)
            g.delete(o.default.length(w));
          else {
            if (typeof w.retain == "number" && w.attributes == null)
              return g.retain(w.retain), p + w.retain;
            if (w.delete || typeof w.retain == "number") {
              const v = w.delete || w.retain;
              return d.slice(p, p + v).forEach((C) => {
                w.delete ? g.push(C) : w.retain && w.attributes && g.retain(o.default.length(C), i.default.invert(w.attributes, C.attributes));
              }), p + v;
            } else if (typeof w.retain == "object" && w.retain !== null) {
              const v = d.slice(p, p + 1), N = new a.default(v.ops).next(), [C, L, q] = u(w.retain, N.insert), j = f.getHandler(C);
              return g.retain({ [C]: j.invert(L, q) }, i.default.invert(w.attributes, N.attributes)), p + 1;
            }
          }
          return p;
        }, 0), g.chop();
      ...
      transform(d, g = !1) {
        ...
        const p = d, w = new a.default(this.ops), v = new a.default(p.ops), N = new f();
        for (; w.hasNext() || v.hasNext(); )
          if (w.peekType() === "insert" && (g || v.peekType() !== "insert"))
            N.retain(o.default.length(w.next()));
          else if (v.peekType() === "insert")
            N.push(v.next());
          else {
            const C = Math.min(w.peekLength(), v.peekLength()), L = w.next(C), q = v.next(C);
            if (L.delete)
              continue;
            if (q.delete)
              N.push(q);
            else {
              const j = L.retain, G = q.retain;
              let z = typeof G == "object" && G !== null ? G : C;
              if (typeof j == "object" && j !== null && typeof G == "object" && G !== null) {
                const ie = Object.keys(j)[0];
                if (ie === Object.keys(G)[0]) {
                  const oe = f.getHandler(ie);
                  oe && (z = {
                    [ie]: oe.transform(j[ie], G[ie], g)
                  });
                }
              }
              N.retain(z, i.default.transform(L.attributes, q.attributes, g));
            }
          }
        return N.chop();
      }
      transformPosition(d, g = !1) {
        ...
        let w = 0;
        for (; p.hasNext() && w <= d; ) {
          const v = p.peekLength(), N = p.peekType();
          if (p.next(), N === "delete") {
            d -= Math.min(v, d - w);
            continue;
          } else N === "insert" && (w < d || !g) && (d += v);
          w += v;
        }
        return d;
      }
...
const ut = class ut extends lo {
  static compare(e, t) {
    const r = ut.order.indexOf(e), s = ut.order.indexOf(t);
    return r >= 0 || s >= 0 ? r - s : e === t ? 0 : e < t ? -1 : 1;
  }
  formatAt(e, t, r, s) {
    if (ut.compare(this.statics.blotName, r) < 0 && this.scroll.query(r, Y.BLOT)) {
      const i = this.isolate(e, t);
      s && i.wrap(r, s);
    } else
  ...
  optimize(e) {
    if (super.optimize(e), this.parent instanceof ut && ut.compare(this.statics.blotName, this.parent.statics.blotName) > 0) {
      const t = this.parent.isolate(this.offset(), this.length());
      this.moveChildren(t), t.wrap(this);
    }
  }
};
$(ut, "allowedChildren", [ut, rt, Me, tt]), // Lower index means deeper in the DOM tree, since not found (-1) is for embeds
$(ut, "order", [
  "cursor",
  "inline",
  // Must be lower
...
Te.tagName = "P";
Te.defaultChild = rt;
Te.allowedChildren = [rt, pt, Me, tt];
class Ke extends Me {
  attach() {
  ...
  insertAt(e, t, r) {
    ...
    const s = t.split(`
`), i = s.pop(), o = s.map((c) => {
      const u = this.scroll.create(Te.blotName);
...
Ke.scope = Y.BLOCK_BLOT;
function La(n) {
  let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0;
  return n.descendants(Ce).reduce((t, r) => r.length() === 0 ? t : t.insert(r.value(), He(r, {}, e)), new J()).insert(`
`, He(n));
}
function He(n) {
  ...
  return n == null || ("formats" in n && typeof n.formats == "function" && (e = {
    ...e,
    ...n.formats()
  }, t && delete e["code-token"]), n.parent == null || n.parent.statics.blotName === "scroll" || n.parent.statics.scope !== n.statics.scope) ? e : He(n.parent, e, t);
}
const Fe = class Fe extends Me {
  // Zero width no break space
  static value() {
  }
  constructor(e, t, r) {
    super(e, t), this.selection = r, this.textNode = document.createTextNode(Fe.CONTENTS), this.domNode.appendChild(this.textNode), this.savedLength = 0;
  }
  detach() {
  ...
  format(e, t) {
    ...
    r != null && (this.savedLength = Fe.CONTENTS.length, r.optimize(), r.formatAt(s, Fe.CONTENTS.length, e, t), this.savedLength = 0);
  }
  index(e, t) {
  ...
  restore() {
    ...
    const t = this.prev instanceof tt ? this.prev : null, r = t ? t.length() : 0, s = this.next instanceof tt ? this.next : null, i = s ? s.text : "", {
      textNode: o
    } = this, a = o.data.split(Fe.CONTENTS).join("");
    o.data = Fe.CONTENTS;
    let c;
    if (t)
    ...
    if (this.remove(), e) {
      const u = (d, g) => t && d === t.domNode ? g : d === o ? r + g - 1 : s && d === s.domNode ? r + a.length + g : null, f = u(e.start.node, e.start.offset), m = u(e.end.node, e.end.offset);
      if (f !== null && m !== null)
        return {
          startNode: c.domNode,
          startOffset: f,
  ...
  optimize(e) {
    ...
    for (; t; ) {
      if (t.domNode.tagName === "A") {
        this.savedLength = Fe.CONTENTS.length, t.isolate(this.offset(t), this.length()).unwrap(), this.savedLength = 0;
        break;
      }
      t = t.parent;
    }
...
$(Fe, "blotName", "cursor"), $(Fe, "className", "ql-cursor"), $(Fe, "tagName", "span"), $(Fe, "CONTENTS", "\uFEFF");
let Cn = Fe;
var di = { exports: {} }, hl;
function Bp() {
  return hl || (hl = 1, (function(n) {
    ...
    function i(c, u, f, m, d) {
      ...
      var g = new s(f, m || c, d), p = t ? t + u : u;
      return c._events[p] ? c._events[p].fn ? c._events[p] = [c._events[p], g] : c._events[p].push(g) : (c._events[p] = g, c._eventsCount++), c;
    }
    function o(c, u) {
    ...
    a.prototype.eventNames = function() {
      ...
      if (!m) return [];
      if (m.fn) return [m.fn];
      for (var d = 0, g = m.length, p = new Array(g); d < g; d++)
        p[d] = m[d].fn;
      return p;
    }, a.prototype.listenerCount = function(u) {
      var f = t ? t + u : u, m = this._events[f];
      return m ? m.fn ? 1 : m.length : 0;
    }, a.prototype.emit = function(u, f, m, d, g, p) {
      var w = t ? t + u : u;
      if (!this._events[w]) return !1;
      var v = this._events[w], N = arguments.length, C, L;
      if (v.fn) {
        switch (v.once && this.removeListener(u, v.fn, void 0, !0), N) {
          case 1:
            return v.fn.call(v.context), !0;
          case 2:
            return v.fn.call(v.context, f), !0;
          case 3:
            return v.fn.call(v.context, f, m), !0;
          case 4:
            return v.fn.call(v.context, f, m, d), !0;
          case 5:
            return v.fn.call(v.context, f, m, d, g), !0;
          case 6:
            return v.fn.call(v.context, f, m, d, g, p), !0;
        }
        for (L = 1, C = new Array(N - 1); L < N; L++)
          C[L - 1] = arguments[L];
        v.fn.apply(v.context, C);
      } else {
        var q = v.length, j;
        for (L = 0; L < q; L++)
          switch (v[L].once && this.removeListener(u, v[L].fn, void 0, !0), N) {
            case 1:
            ...
            case 2:
              ...
              break;
            case 3:
              v[L].fn.call(v[L].context, f, m);
              break;
            case 4:
              v[L].fn.call(v[L].context, f, m, d);
              break;
            default:
              if (!C) for (j = 1, C = new Array(N - 1); j < N; j++)
                C[j - 1] = arguments[j];
              v[L].fn.apply(v[L].context, C);
          }
      }
      return !0;
      ...
      if (p.fn)
        p.fn === f && (!d || p.once) && (!m || p.context === m) && o(this, g);
      else {
        for (var w = 0, v = [], N = p.length; w < N; w++)
          (p[w].fn !== f || d && !p[w].once || m && p[w].context !== m) && v.push(p[w]);
...
qa.level = St.level;
const pi = St("quill:events"), Dp = ["selectionchange", "mousedown", "mouseup", "click"];
Dp.forEach((n) => {
...
class Up {
    ...
    this.emitter = t, this.scroll = e, this.composing = !1, this.mouseDown = !1, this.root = this.scroll.domNode, this.cursor = this.scroll.create("cursor", this), this.savedRange = new Qt(0, 0), this.lastRange = this.savedRange, this.lastNative = null, this.handleComposition(), this.handleDragging(), this.emitter.listenDOM("selectionchange", document, () => {
      ...
      r != null && r.start.node !== this.cursor.textNode && this.emitter.once(V.events.SCROLL_UPDATE, (s, i) => {
        try {
          ...
          this.update(o ? V.sources.SILENT : s);
        } catch {
        }
      });
      ...
      if (s.range) {
        ...
        this.setNativeRange(i, o, a, c), this.update(V.sources.SILENT);
      }
  ...
  update() {
    ...
    if (this.lastRange = r, this.lastNative = s, this.lastRange != null && (this.savedRange = this.lastRange), !oo(t, this.lastRange)) {
      ...
      const i = [V.events.SELECTION_CHANGE, Tn(this.lastRange), Tn(t), e];
...
class Fp {
  ...
  applyDelta(e) {
    ...
    return zp(r.ops.slice()).reduce((o, a) => {
      const c = Ve.Op.length(a);
      let u = a.attributes || {}, f = !1, m = !1;
      if (a.insert != null) {
        if (s.retain(c), typeof a.insert == "string") {
          const p = a.insert;
          m = !p.endsWith(`
`) && (t <= o || !!this.scroll.descendant(Ke, o)[0]), this.scroll.insertAt(o, p);
          const [w, v] = this.scroll.line(o);
          let N = Bt({}, He(w));
          if (w instanceof Te) {
            const [C] = w.descendant(Ce, v);
            C && (N = Bt(N, He(C)));
          }
          u = Ve.AttributeMap.diff(N, u) || {};
        } else if (typeof a.insert == "object") {
          const p = Object.keys(a.insert)[0];
          if (p == null) return o;
          const w = this.scroll.query(p, Y.INLINE) != null;
          if (w)
            (t <= o || this.scroll.descendant(Ke, o)[0]) && (m = !0);
          else if (o > 0) {
            const [v, N] = this.scroll.descendant(Ce, o - 1);
            v instanceof tt ? v.value()[N] !== `
` && (f = !0) : v instanceof Me && v.statics.scope === Y.INLINE_BLOT && (f = !0);
          }
          if (this.scroll.insertAt(o, p, a.insert[p]), w) {
            const [v] = this.scroll.descendant(Ce, o);
            if (v) {
              const N = Bt({}, He(v));
              u = Ve.AttributeMap.diff(N, u) || {};
            }
      ...
      const d = f ? 1 : 0, g = m ? 1 : 0;
      return t += d + g, s.retain(d), s.delete(g), o + c + d + g;
    }, 0), s.reduce((o, a) => typeof a.delete == "number" ? (this.scroll.deleteAt(o, a.delete), o) : o + Ve.Op.length(a), 0), this.scroll.batchEnd(), this.scroll.optimize(), this.update(r);
  }
  deleteText(e, t) {
  ...
  formatLine(e, t) {
    ...
    const s = new J().retain(e).retain(t, Tn(r));
  ...
  getFormat(e) {
    ...
    t === 0 ? this.scroll.path(e).forEach((a) => {
      const [c] = a;
      c instanceof Te ? r.push(c) : c instanceof Ce && s.push(c);
...
`), this.scroll.insertAt(e, t), Object.keys(r).forEach((s) => {
    ...
    }), this.update(new J().retain(e).insert(t, Tn(r)));
  }
  isBlank() {
    if (this.scroll.children.length === 0) return !0;
    if (this.scroll.children.length > 1) return !1;
    const e = this.scroll.children.head;
    if ((e == null ? void 0 : e.statics.blotName) !== Te.blotName) return !1;
    const t = e;
...
`));
  ...
  update(e) {
    ...
    t[0].target.data.match($p) && this.scroll.find(t[0].target)) {
      const i = this.scroll.find(t[0].target), o = He(i), a = i.offset(this.scroll), c = t[0].oldValue.replace(Cn.CONTENTS, ""), u = new J().insert(c), f = new J().insert(i.value()), m = r && {
        oldRange: dl(r.oldRange, -a),
        newRange: dl(r.newRange, -a)
      };
      e = new J().retain(a).concat(u.diff(f, m)).reduce((g, p) => p.insert ? g.insert(p.insert, o) : g.push(p), new J()), this.delta = s.compose(e);
    } else
...
class Kp {
  ...
  handleCompositionStart(e) {
    ...
    t && !(t instanceof co) && (this.emitter.emit(V.events.COMPOSITION_BEFORE_START, e), this.scroll.batchStart(), this.emitter.emit(V.events.COMPOSITION_START, e), this.isComposing = !0);
  }
  ...
  for (; s; ) {
    ...
    if (m || d)
      if (c)
        ...
        const w = s.scrollLeft - g, v = s.scrollTop - p;
        r = {
          left: r.left - w,
          top: r.top - v,
          right: r.right - w,
...
const Ye = class Ye {
  ...
  constructor(e) {
    ...
    this.container.classList.add("ql-container"), this.container.innerHTML = "", Mi.set(this.container, this), this.root = this.addContainer("ql-editor"), this.root.classList.add("ql-blank"), this.emitter = new V();
    const s = ao.blotName, i = this.options.registry.query(s);
    if (!i || !("blotName" in i))
      throw new Error(`Cannot initialize Quill without "${s}" blot`);
    if (this.scroll = new i(this.options.registry, this.root, {
      emitter: this.emitter
    }), this.editor = new Fp(this.scroll), this.selection = new Up(this.scroll, this.emitter), this.composition = new Kp(this.scroll, this.emitter), this.theme = new this.options.theme(this, this.options), this.keyboard = this.theme.addModule("keyboard"), this.clipboard = this.theme.addModule("clipboard"), this.history = this.theme.addModule("history"), this.uploader = this.theme.addModule("uploader"), this.theme.addModule("input"), this.theme.addModule("uiNode"), this.theme.init(), this.emitter.on(V.events.EDITOR_CHANGE, (o) => {
      o === V.events.TEXT_CHANGE && this.root.classList.toggle("ql-blank", this.editor.isBlank());
    }), this.emitter.on(V.events.SCROLL_UPDATE, (o, a) => {
      const c = this.selection.lastRange, [u] = this.selection.getRange(), f = c && u ? {
        oldRange: c,
        newRange: u
      } : void 0;
      Je.call(this, () => this.editor.update(null, a, f), o);
    }), this.emitter.on(V.events.SCROLL_EMBED_UPDATE, (o, a) => {
      const c = this.selection.lastRange, [u] = this.selection.getRange(), f = c && u ? {
        oldRange: c,
        newRange: u
      } : void 0;
...
`
  ...
  deleteText(e, t, r) {
    return [e, t, , r] = Et(e, t, r), Je.call(this, () => this.editor.deleteText(e, t), r, e, -1 * t);
  }
  disable() {
    this.enable(!1);
  }
  ...
  insertText(e, t, r, s, i) {
    let o;
    return [e, , o, i] = Et(e, 0, r, s, i), Je.call(this, () => this.editor.insertText(e, t, o), i, e, t.length);
  }
  isEnabled() {
  ...
  removeFormat(e, t, r) {
    return [e, t, , r] = Et(e, t, r), Je.call(this, () => this.editor.removeFormat(e, t), r, e);
  }
  ...
  setSelection(e, t, r) {
    e == null ? this.selection.setRange(null, t || Ye.sources.API) : ([e, t, , r] = Et(e, t, r), this.selection.setRange(new Qt(Math.max(0, e), t), r), r !== V.sources.SILENT && this.scrollSelectionIntoView());
  }
  setText(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : V.sources.API;
  ...
  updateContents(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : V.sources.API;
    return Je.call(this, () => (e = new J(e), this.editor.applyDelta(e)), t, !0);
  }
};
$(Ye, "DEFAULTS", {
  bounds: null,
  ...
  registry: Jr,
  theme: "default"
}), $(Ye, "events", V.events), $(Ye, "sources", V.sources), $(Ye, "version", "2.0.2"), $(Ye, "imports", {
  delta: J,
  parchment: Lp,
  "core/module": st,
  "core/theme": Rn
...
function Xp(n, e) {
  ...
  return d ? e.formats && Sn.warn('Ignoring "formats" option because "registry" is specified') : d = e.formats ? Yp(e.formats, m.registry, Sn) : m.registry, {
    ...
    container: t,
    theme: s,
    modules: Object.entries(f).reduce((g, p) => {
      let [w, v] = p;
      if (!v) return g;
      const N = O.import(`modules/${w}`);
      return N == null ? (Sn.error(`Cannot load ${w} module. Are you sure you registered it?`), g) : {
        ...g,
        // @ts-expect-error
        [w]: Bt({}, N.DEFAULTS || {}, v)
      };
...
function Je(n, e, t, r) {
  ...
  if (s != null && (t === !0 && (t = s.index), r == null ? s = bl(s, o, e) : r !== 0 && (s = bl(s, t, r, e)), this.setSelection(s, V.sources.SILENT)), o.length() > 0) {
    const a = [V.events.TEXT_CHANGE, o, i, e];
...
function bl(n, e, t, r) {
  ...
  return e && typeof e.transformPosition == "function" ? [i, o] = [n.index, n.index + n.length].map((a) => (
    ...
    e.transformPosition(a, r !== V.sources.USER)
  )) : [i, o] = [n.index, n.index + n.length].map((a) => a < e || a === e && r === V.sources.USER ? a : s >= 0 ? a + s : Math.max(e, a + s)), new Qt(i, o - i);
}
class sn extends ms {
}
function yl(n) {
  return n instanceof Te || n instanceof Ke;
}
function vl(n) {
...
class xn extends ao {
  ...
  deleteAt(e, t) {
    ...
    if (super.deleteAt(e, t), i != null && r !== i && s > 0) {
      if (r instanceof Ke || i instanceof Ke) {
        this.optimize();
        return;
      }
...
`))), s = r.pop();
    ...
    const i = r.shift();
    if (i) {
      const c = i.type === "block" && (i.delta.length() === 0 || !this.descendant(Ke, e)[0] && e < this.length()), u = i.type === "block" ? i.delta : new J().insert({
        [i.key]: i.value
      });
      vi(this, e, u);
      ...
      c && this.insertAt(m - 1, `
`);
      const d = He(this.line(e)[0]), g = Ve.AttributeMap.diff(d, i.attributes) || {};
      Object.keys(g).forEach((p) => {
        this.formatAt(m - 1, 1, p, g[p]);
      }), e = m;
    }
  ...
  updateEmbedAt(e, t, r) {
    const [s] = this.descendant((i) => i instanceof Ke, e);
...
$(xn, "blotName", "scroll"), $(xn, "className", "ql-editor"), $(xn, "tagName", "DIV"), $(xn, "defaultChild", Te), $(xn, "allowedChildren", [Te, Ke, sn]);
function vi(n, e, t) {
  t.reduce((r, s) => {
    const i = Ve.Op.length(s);
    let o = s.attributes || {};
    if (s.insert != null) {
      if (typeof s.insert == "string") {
        const a = s.insert;
        n.insertAt(r, a);
        const [c] = n.descendant(Ce, r), u = He(c);
        o = Ve.AttributeMap.diff(u, o) || {};
      } else if (typeof s.insert == "object") {
        const a = Object.keys(s.insert)[0];
        if (a == null) return r;
        if (n.insertAt(r, a, s.insert[a]), n.scroll.query(a, Y.INLINE) != null) {
          const [u] = n.descendant(Ce, r), f = He(u);
          o = Ve.AttributeMap.diff(f, o) || {};
        }
      }
    }
...
}, Qp = new dt("align", "align", uo), Ia = new nt("align", "ql-align", uo), ka = new Dt("align", "text-align", uo);
class ja extends Dt {
  value(e) {
    let t = super.value(e);
...
const mo = {
  scope: Y.BLOCK,
  whitelist: ["rtl"]
}, Ba = new dt("direction", "dir", mo), Pa = new nt("direction", "ql-direction", mo), Ma = new Dt("direction", "direction", mo), Da = {
  scope: Y.INLINE,
...
}), rm = St("quill:keyboard"), sm = /Mac/i.test(navigator.platform) ? "metaKey" : "ctrlKey";
class bs extends st {
  static match(e, t) {
  ...
  listen() {
    this.quill.root.addEventListener("keydown", (e) => {
      ...
      const [a, c] = this.quill.getLine(o.index), [u, f] = this.quill.getLeaf(o.index), [m, d] = o.length === 0 ? [u, f] : this.quill.getLeaf(o.index + o.length), g = u instanceof cs ? u.value().slice(0, f) : "", p = m instanceof cs ? m.value().slice(d) : "", w = {
      ...
      s.some((N) => {
        if (N.collapsed != null && N.collapsed !== w.collapsed || N.empty != null && N.empty !== w.empty || N.offset != null && N.offset !== w.offset)
          return !1;
        if (Array.isArray(N.format)) {
          if (N.format.every((C) => w.format[C] == null))
            return !1;
        } else if (typeof N.format == "object" && !Object.keys(N.format).every((C) => N.format[C] === !0 ? w.format[C] != null : N.format[C] === !1 ? w.format[C] == null : oo(N.format[C], w.format[C])))
          return !1;
        return N.prefix != null && !N.prefix.test(w.prefix) || N.suffix != null && !N.suffix.test(w.suffix) ? !1 : N.handler.call(this, o, w, N) !== !0;
      }) && e.preventDefault();
    });
  }
  handleBackspace(e, t) {
    ...
    if (t.offset === 0) {
      ...
      if (a && !(a.statics.blotName === "block" && a.length() <= 1)) {
        ...
        if (s = Ve.AttributeMap.diff(u, f) || {}, Object.keys(s).length > 0) {
  ...
  handleDelete(e, t) {
    ...
    if (t.offset >= i.length() - 1) {
      ...
      if (a) {
        ...
        s = Ve.AttributeMap.diff(c, u) || {}, Object.keys(s).length > 0 && (o = o.retain(a.length() - 1).retain(1, s));
      }
    }
    this.quill.updateContents(o, O.sources.USER), this.quill.focus();
  }
...
const dm = /\bmso-list:[^;]*ignore/i, pm = /\bmso-list:[^;]*\bl(\d+)/i, mm = /\bmso-list:[^;]*\blevel(\d+)/i, gm = (n, e) => {
  ...
  for (; i.length; ) {
    ...
    c.forEach((g) => {
      ...
      p.setAttribute("data-list", g.type), g.indent > 1 && p.setAttribute("class", `ql-indent-${g.indent - 1}`), p.innerHTML = g.element.innerHTML, f.appendChild(p);
    });
    const m = (a = c[0]) == null ? void 0 : a.element, {
      parentNode: d
    } = m ?? {};
    m && (d == null || d.replaceChild(f, m)), c.slice(1).forEach((g) => {
      let {
        element: p
      } = g;
...
}, Em = St("quill:clipboard"), xm = [[Node.TEXT_NODE, km], [Node.TEXT_NODE, Tl], ["br", _m], [Node.ELEMENT_NODE, Tl], [Node.ELEMENT_NODE, Sm], [Node.ELEMENT_NODE, Am], [Node.ELEMENT_NODE, qm], ["li", Rm], ["ol, ul", Lm], ["pre", Om], ["tr", Im], ["b", Ei("bold")], ["i", Ei("italic")], ["strike", Ei("strike")], ["style", Cm]], Nm = [Qp, Ba].reduce((n, e) => (n[e.keyName] = e, n), {}), Nl = [ka, fo, ho, Ma, $a, Ha].reduce((n, e) => (n[e.keyName] = e, n), {});
class za extends st {
  constructor(e, t) {
...
function Am(n, e, t) {
  const r = dt.keys(n), s = nt.keys(n), i = Dt.keys(n), o = {};
...
`);
        const s = t.query(r);
        if (s && s.prototype instanceof Ke)
          return e.insert(`
`);
        r = r.firstChild;
      }
...
`) && !Tm(n, t))
    ...
    r = r.replace(/\r\n/g, " ").replace(/\n/g, " "), r = r.replace(/\s\s+/g, i.bind(i, !0)), (n.previousSibling == null && n.parentElement != null && kt(n.parentElement, t) || n.previousSibling instanceof Element && kt(n.previousSibling, t)) && (r = r.replace(/^\s+/, i.bind(i, !1))), (n.nextSibling == null && n.parentElement != null && kt(n.parentElement, t) || n.nextSibling instanceof Element && kt(n.nextSibling, t)) && (r = r.replace(/\s+$/, i.bind(i, !1)));
  }
  return e.insert(r);
}
class Va extends st {
...
$(jt, "blotName", "link"), $(jt, "tagName", "A"), $(jt, "SANITIZED_URL", "about:blank"), $(jt, "PROTOCOL_WHITELIST", ["http", "https", "mailto", "tel", "sms"]);
function Wa(n, e) {
...
class Nt extends pt {
  ...
  format(e, t) {
    e !== Nt.blotName ? super.format(e, t) : t ? nr.add(this.domNode, t) : (nr.remove(this.domNode), this.domNode.classList.remove(this.statics.className));
  }
  optimize() {
...
class ir extends on {
  ...
  format(e, t) {
    e === ze.blotName && (this.forceNext = !0, this.children.forEach((r) => {
      r.format(e, t);
    }));
  }
  formatAt(e, t, r, s) {
    r === ze.blotName && (this.forceNext = !0), super.formatAt(e, t, r, s);
  }
  highlight(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
...
`)}
`, i = ze.formats(this.children.head.domNode);
      ...
      if (s.trim().length > 0 || this.cachedText == null) {
        ...
        o.diff(a).reduce((c, u) => {
          ...
          return f ? (m && Object.keys(m).forEach((d) => {
            [ze.blotName, Nt.blotName].includes(d) && this.formatAt(c, f, d, m[d]);
          }), c + f) : c;
        }, 0);
      }
  ...
  html(e, t) {
    ...
    return `<pre data-language="${r ? ze.formats(r.domNode) : "plain"}">
${gs(this.code(e, t))}
</pre>`;
  }
  optimize(e) {
    if (super.optimize(e), this.parent != null && this.children.head != null && this.uiNode != null) {
      const t = ze.formats(this.children.head.domNode);
      t !== this.uiNode.value && (this.uiNode.value = t);
    }
  }
}
ir.allowedChildren = [ze];
ze.requiredContainer = ir;
ze.allowedChildren = [Nt, Cn, tt, rt];
const Vm = (n, e, t) => {
...
class Za extends st {
  static register() {
    O.register(Nt, !0), O.register(ze, !0), O.register(ir, !0);
  }
  constructor(e, t) {
  ...
  initListener() {
    this.quill.on(O.events.SCROLL_BLOT_MOUNT, (e) => {
      ...
      this.options.languages.forEach((r) => {
        ...
        e.format(ze.blotName, t.value), this.quill.root.focus(), this.highlight(e, !0);
      }), e.uiNode == null && (e.attachUI(t), e.children.head && (t.value = ze.formats(e.children.head.domNode)));
    });
  }
  initTimer() {
    let e = null;
...
$(Tt, "blotName", "table-row"), $(Tt, "tagName", "TR");
class ft extends sn {
}
$(ft, "blotName", "table-body"), $(ft, "tagName", "TBODY");
class Ln extends sn {
  balanceCells() {
    const e = this.descendants(Tt), t = e.reduce((r, s) => Math.max(s.children.length, r), 0);
    e.forEach((r) => {
  ...
  insertRow(e) {
    ...
    const r = yo(), s = this.scroll.create(Tt.blotName);
...
Ln.allowedChildren = [ft];
ft.requiredContainer = Ln;
ft.allowedChildren = [Tt];
Tt.requiredContainer = ft;
Tt.allowedChildren = [Qe];
Qe.requiredContainer = Tt;
function yo() {
  return `row-${Math.random().toString(36).slice(2, 6)}`;
}
class Gm extends st {
  static register() {
    O.register(Qe), O.register(Tt), O.register(ft), O.register(Ln);
  }
  constructor() {
...
class ec extends Qa {
  constructor(e, t) {
    super(e, t), this.quill.on(V.events.EDITOR_CHANGE, (r, s, i, o) => {
      if (r === V.events.SELECTION_CHANGE)
        if (s != null && s.length > 0 && o === V.sources.USER) {
  ...
  listen() {
    super.listen(), this.root.querySelector("a.ql-action").addEventListener("click", (t) => {
      ...
      if (this.linkRange != null) {
        ...
        this.restoreFocus(), this.quill.formatText(r, "link", !1, V.sources.USER), delete this.linkRange;
      }
      t.preventDefault(), this.hide();
    }), this.quill.on(V.events.SELECTION_CHANGE, (t, r, s) => {
      if (t != null) {
        if (t.length === 0 && s === V.sources.USER) {
...
const Mg = ({
  ...
  const [e, t] = Oe(
    () => n != null && n.length ? n.map((j, G) => ({ id: `default-${G}`, email: j })) : []
  ), [r, s] = Oe([]), [i, o] = Oe([]), [a, c] = Oe(!1), [u, f] = Oe(!1), [m, d] = Oe(""), [g, p] = Oe(""), [w, v] = Oe(""), N = (j, G) => {
    const z = j.trim();
    if (!z || !Dg(z))
      return;
    const ie = {
    ...
    if (G === "to") {
      if (e.some((oe) => oe.email.toLowerCase() === z.toLowerCase()))
        return;
      t((oe) => [...oe, ie]), d("");
    } else if (G === "cc") {
      if (r.some((oe) => oe.email.toLowerCase() === z.toLowerCase()))
        return;
      s((oe) => [...oe, ie]), p("");
    } else {
      if (i.some((oe) => oe.email.toLowerCase() === z.toLowerCase()))
        return;
      o((oe) => [...oe, ie]), v("");
    }
  };
  return {
    ...
    setBccInput: v,
    addRecipient: N,
    handleRecipientInputKeyDown: (j, G) => {
      if (j.key === "Enter" || j.key === ",") {
        j.preventDefault();
        const z = G === "to" ? m : G === "cc" ? g : w;
        z && N(z, G);
      }
    },
    handleRecipientInputBlur: (j) => {
      const G = j === "to" ? m : j === "cc" ? g : w;
      G && N(G, j);
    },
    removeRecipient: (j, G) => {
      G === "to" ? t((z) => z.filter((ie) => ie.id !== j)) : G === "cc" ? s((z) => z.filter((ie) => ie.id !== j)) : o((z) => z.filter((ie) => ie.id !== j));
    }
  };
}, $g = (n) => {
  ...
  return {
    ...
    handleFileSelect: (a) => {
      ...
      t((u) => [...u, ...c]), c.forEach((u) => {
        n.uploadFile(u.file).then((f) => {
          const m = f == null ? void 0 : f.name;
          t(
            m ? (d) => d.map((g) => g.id === u.id ? { ...g, fileName: m, isUploading: !1 } : g) : (d) => d.map((g) => g.id === u.id ? { ...g, isUploading: !1, uploadError: "Upload failed" } : g)
          );
        }).catch((f) => {
          t(
            (m) => m.map(
  ...
  const [s, i] = Oe(""), [o, a] = Oe(""), [c, u] = Oe(!1), [f, m] = Oe(!1), [d, g] = Oe([]), [p, w] = Oe(!1), {
    toRecipients: v,
    setToRecipients: N,
    ccRecipients: C,
    setCcRecipients: L,
    ...
    bccInput: P,
    setBccInput: k,
    handleRecipientInputKeyDown: S,
    handleRecipientInputBlur: M,
    removeRecipient: U
  ...
  Nn(() => {
    ...
    queueMicrotask(() => {
      ...
      const te = (Z) => Z ? Z.split(",").map((re) => re.trim()).filter(Boolean).map((re) => ({
        id: Date.now().toString() + Math.random().toString(36).substr(2, 9),
        email: re
      })) : [];
      if (I.to && N(te(I.to)), I.cc) {
        const Z = te(I.cc);
        Z.length > 0 && (L(Z), z(!0));
      }
      if (I.bcc) {
    ...
    var Z;
    if (!((Z = e.defaultToEmails) != null && Z.length) || I != null && I.to) return;
    const W = e.defaultToEmails;
    queueMicrotask(() => {
      N(
        (re) => re.length === 0 ? W.map((le, ae) => ({ id: `default-${ae}`, email: le })) : re
      );
    });
  }, [e.defaultToEmails, I, N]);
  const K = Ic(() => {
    let W = "", te;
    if (I != null && I.content) {
      const Z = I.date && I.time ? `${I.date} at ${I.time}` : "the previous message";
      W = `<br><hr><br><div><b>From:</b> ${I.senderName || I.to || "User"}<br><b>Sent:</b> ${Z}<br><b>Subject:</b> ${I.subject || ""}</div><br><div>${I.content}</div>`;
    }
    return I != null && I.in_reply_to && (te = I.in_reply_to), { quotedContent: W, inReplyTo: te };
  }, [I]);
  return Nn(() => {
    if (!f || !n.getTemplates) return;
    let W = !0;
    return d.length === 0 && w(!0), n.getTemplates().then((te) => {
      W && (g(te), w(!1));
    }).catch(() => {
      W && w(!1);
    }), () => {
    ...
    handleAttachClick: H,
    handleSend: async () => {
      var ne, Ot, $t, Ft, Pe, gt, an, ot;
      if (v.length === 0) {
        (ne = n.showWarning) == null || ne.call(n, "Validation Error", "Please add at least one recipient");
        return;
      }
      if (!s.trim()) {
        (Ot = n.showWarning) == null || Ot.call(n, "Validation Error", "Please enter a subject");
        return;
      }
      if (F.filter((ge) => ge.isUploading).length > 0) {
        ($t = n.showWarning) == null || $t.call(n, "Upload In Progress", "Please wait for all files to finish uploading");
        return;
      }
      if (F.filter((ge) => ge.uploadError).length > 0) {
        (Ft = n.showWarning) == null || Ft.call(n, "Upload Error", "Some files failed to upload. Please remove them and try again.");
        return;
      }
      const Z = v.map((ge) => ge.email).join(", "), re = C.length > 0 ? C.map((ge) => ge.email).join(", ") : void 0, le = q.length > 0 ? q.map((ge) => ge.email).join(", ") : void 0, ae = F.filter((ge) => ge.fileName).map((ge) => ge.fileName);
      let me = o ? `<div class="ql-editor read-mode">${o}</div>` : "";
      const { quotedContent: ve, inReplyTo: De } = K();
      me += ve;
      const Ge = [...e.links ?? []];
      (Pe = e.activeLeadName) != null && Pe.trim() && (Ge.some(
        (Ct) => Ct.link_doctype === e.activeLeadDoctype && Ct.link_name === e.activeLeadName
      ) || Ge.push({ link_doctype: e.activeLeadDoctype, link_name: e.activeLeadName }));
      const Ut = Ge.length > 0 ? Ge : void 0, _t = {
        recipients: Z,
        subject: s,
        content: me,
        cc: re,
        bcc: le,
        doctype: e.activeLeadName ? e.activeLeadDoctype : "Contact",
      ...
      u(!0);
      try {
        const ge = await n.sendEmail(_t);
        ge != null && ge.name && (De && n.updateCommunicationStatus && n.updateCommunicationStatus(De, "Replied").catch(() => {
        }), (gt = n.showNotification) == null || gt.call(n, "Success", "Email sent successfully"), (an = n.onEmailSent) == null || an.call(n), r && r(), t());
      } catch {
        (ot = n.showError) == null || ot.call(n, "Error", "Failed to send email");
      } finally {
        u(!1);
      }
    },
    handleTemplateSelect: (W) => {
      a(W), m(!1);
    }
  };
};
...
const Kg = Es("string"), je = Es("function"), lc = Es("number"), Er = (n) => n !== null && typeof n == "object", Vg = (n) => n === !0 || n === !1, rs = (n) => {
  if (ws(n) !== "object")
    return !1;
  const e = wo(n);
...
}, Wg = it("Date"), Zg = it("File"), Jg = (n) => !!(n && typeof n.uri < "u"), Yg = (n) => n && typeof n.getParts < "u", Xg = it("Blob"), Qg = it("FileList"), e1 = (n) => Er(n) && je(n.pipe);
function t1() {
  return typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {};
}
const Il = t1(), kl = typeof Il.FormData < "u" ? Il.FormData : void 0, n1 = (n) => {
  let e;
  return n && (kl && n instanceof kl || je(n.append) && ((e = ws(n)) === "formdata" || // detect form-data instance
...
}, T1 = (n, e) => n != null && Number.isFinite(n = +n) ? n : e;
function A1(n) {
...
const S1 = (n) => {
  ...
  return t(n, 0);
}, _1 = it("AsyncFunction"), O1 = (n) => n && (Er(n) || je(n)) && je(n.then) && je(n.catch), hc = ((n, e) => n ? setImmediate : e ? ((t, r) => (Zt.addEventListener(
  "message",
  ({ source: s, data: i }) => {
...
}))(`axios@${Math.random()}`, []) : (t) => setTimeout(t))(typeof setImmediate == "function", je(Zt.postMessage)), C1 = typeof queueMicrotask < "u" ? queueMicrotask.bind(Zt) : typeof process < "u" && process.nextTick || hc, R1 = (n) => n != null && je(n[vs]), T = {
  isArray: kn,
  isArrayBuffer: oc,
  isBuffer: wr,
  isFormData: n1,
...
function xs(n, e, t) {
  ...
  function f(p, w, v) {
    ...
    if (T.isReactNative(e) && T.isReactNativeBlob(p))
      return e.append(xi(v, w, i), u(p)), !1;
    if (p && !v && typeof p == "object") {
      if (T.endsWith(w, "{}"))
        w = r ? w : w.slice(0, -2), p = JSON.stringify(p);
      else if (T.isArray(p) && q1(p) || (T.isFileList(p) || T.endsWith(w, "[]")) && (N = T.toArray(p)))
        return w = dc(w), N.forEach(function(L, q) {
          !(T.isUndefined(L) || L === null) && e.append(
            // eslint-disable-next-line no-nested-ternary
            o === !0 ? xi([w], q, i) : o === null ? w : w + "[]",
            u(L)
          );
        }), !1;
    }
    return Ji(p) ? !0 : (e.append(xi(v, w, i), u(p)), !1);
  }
  ...
  function g(p, w) {
    if (!T.isUndefined(p)) {
      ...
      m.push(p), T.forEach(p, function(N, C) {
        (!(T.isUndefined(N) || N === null) && s.call(e, N, T.isString(C) ? C.trim() : C, w, d)) === !0 && g(N, w ? w.concat(C) : [C]);
      }), m.pop();
    }
  }
  if (!T.isObject(n))
...
function mc(n, e, t) {
  if (!e)
    return n;
  const r = t && t.encode || k1, s = T.isFunction(t) ? {
    serialize: t
  } : t, i = s && s.serialize;
  let o;
...
function gc(n) {
  function e(t, r, s, i) {
    ...
    return o = !o && T.isArray(s) ? s.length : o, c ? (T.hasOwnProp(s, o) ? s[o] = [s[o], r] : s[o] = r, !a) : ((!s[o] || !T.isObject(s[o])) && (s[o] = []), e(t, r, s[o], i) && T.isArray(s[o]) && (s[o] = K1(s[o])), !a);
  }
...
let Be = class {
  ...
  set(e, t, r) {
    ...
    if (T.isPlainObject(e) || e instanceof this.constructor)
      o(e, t);
    else if (T.isString(e) && (e = e.trim()) && !J1(e))
      o(W1(e), t);
...
T.freezeMethods(Be);
function Ti(n, e) {
  const t = this || Nr, r = e || t, s = Be.from(r.headers);
  let i = r.data;
...
let Tr = class extends ee {
   ...
   */
  constructor(e, t, r) {
    super(e ?? "canceled", ee.ERR_CANCELED, t, r), this.name = "CanceledError", this.__CANCEL__ = !0;
  }
};
function yc(n, e, t) {
...
}, Ul = (n) => (...e) => T.asap(() => n(...e)), nb = Re.hasStandardBrowserEnv ? /* @__PURE__ */ ((n, e) => (t) => (t = new URL(t, Re.origin), n.protocol === t.protocol && n.host === t.host && (e || n.port === t.port)))(
  new URL(Re.origin),
...
const wc = (n) => {
  ...
  if (Re.hasStandardBrowserEnv && (r && T.isFunction(r) && (r = r(e)), r || r !== !1 && nb(e.url))) {
  ...
  return new Promise(function(t, r) {
    ...
    let { responseType: a, onUploadProgress: c, onDownloadProgress: u } = s, f, m, d, g, p;
    function w() {
    ...
    "onloadend" in v ? v.onloadend = N : v.onreadystatechange = function() {
      !v || v.readyState !== 4 || v.status === 0 && !(v.responseURL && v.responseURL.indexOf("file:") === 0) || setTimeout(N);
    }, v.onabort = function() {
      v && (r(new ee("Request aborted", ee.ECONNABORTED, n, v)), v = null);
    }, v.onerror = function(q) {
      const j = q && q.message ? q.message : "Network Error", G = new ee(j, ee.ERR_NETWORK, n, v);
      G.event = q || null, r(G), v = null;
    }, v.ontimeout = function() {
      let q = s.timeout ? "timeout of " + s.timeout + "ms exceeded" : "timeout exceeded";
      const j = s.transitional || xo;
      s.timeoutErrorMessage && (q = s.timeoutErrorMessage), r(
        new ee(
          q,
    ...
    }, i === void 0 && o.setContentType(null), "setRequestHeader" in v && T.forEach(o.toJSON(), function(q, j) {
      v.setRequestHeader(j, q);
    }), T.isUndefined(s.withCredentials) || (v.withCredentials = !!s.withCredentials), a && a !== "json" && (v.responseType = s.responseType), u && ([d, p] = us(u, !0), v.addEventListener("progress", d)), c && v.upload && ([m, g] = us(c), v.upload.addEventListener("progress", m), v.upload.addEventListener("loadend", g)), (s.cancelToken || s.signal) && (f = (L) => {
      v && (r(!L || L.type ? new Tr(null, n, v) : L), v.abort(), v = null);
  ...
  if (e || t) {
    ...
    const i = function(u) {
      if (!s) {
        ...
        r.abort(
          f instanceof ee ? f : new Tr(f instanceof Error ? f.message : f)
        );
      }
    };
    let o = e && setTimeout(() => {
      o = null, i(new ee(`timeout of ${e}ms exceeded`, ee.ETIMEDOUT));
    }, e);
    const a = () => {
...
}, Hl = 64 * 1024, { isFunction: Qr } = T, fb = (({ Request: n, Response: e }) => ({
  Request: n,
  Response: e
  ...
  if (!s)
    return !1;
  const a = s && Qr(zl), c = s && (typeof Kl == "function" ? /* @__PURE__ */ ((p) => (w) => p.encode(w))(new Kl()) : async (p) => new Uint8Array(await new t(p).arrayBuffer())), u = i && a && Vl(() => {
    let p = !1;
    const w = new t(Re.origin, {
      body: new zl(),
      method: "POST",
      get duplex() {
        return p = !0, "half";
  ...
  const d = async (p) => {
    ...
    const v = T.toFiniteNumber(p.getContentLength());
    return v ?? d(w);
  };
  return async (p) => {
    let {
    ...
    const P = R && R.unsubscribe && (() => {
      R.unsubscribe();
    });
    let k;
    try {
      if (G && u && v !== "get" && v !== "head" && (k = await g(ie, N)) !== 0) {
        let x = new t(w, {
          method: "POST",
          body: N,
          duplex: "half"
        }), B;
        if (T.isFormData(N) && (B = x.headers.get("content-type")) && ie.setContentType(B), x.body) {
          const [H, I] = Dl(
            k,
            us(Ul(G))
          );
      ...
      T.isString(oe) || (oe = oe ? "include" : "omit");
      const S = i && "credentials" in t.prototype, M = {
        ...pe,
        signal: R,
        ...
        body: N,
        duplex: "half",
        credentials: S ? oe : void 0
      };
      E = i && new t(w, M);
      let U = await (i ? b(E, pe) : b(w, M));
      const F = f && (z === "stream" || z === "response");
      if (f && (j || F && P)) {
        const x = {};
        ["status", "statusText", "headers"].forEach((K) => {
          x[K] = U[K];
        });
        const B = T.toFiniteNumber(U.headers.get("content-length")), [H, I] = j && Dl(
          B,
          us(Ul(j), !0)
        ) || [];
        U = new r(
      ...
      z = z || "text";
      let D = await m[T.findKey(m, z) || "text"](
        U,
        p
      );
      return !F && P && P(), await new Promise((x, B) => {
        yc(x, B, {
          data: D,
      ...
      ) : ee.from(S, S && S.code, p, E, S && S.response);
    }
  };
...
const Gl = (n) => `- ${n}`, mb = (n) => T.isFunction(n) || n === null || n === !1;
function gb(n, e) {
  n = T.isArray(n) ? n : [n];
  const { length: t } = n;
  let r, s;
  ...
  for (let o = 0; o < t; o++) {
    r = n[o];
    let a;
    if (s = r, !mb(r) && (s = To[(a = String(r)).toLowerCase()], s === void 0))
...
function Wl(n) {
  return Ai(n), n.headers = Be.from(n.headers), n.data = Ti.call(n, n.transformRequest), ["post", "put", "patch"].indexOf(n.method) !== -1 && n.headers.setContentType("application/x-www-form-urlencoded", !1), xc.getAdapter(n.adapter || Nr.adapter, n)(n).then(
    function(r) {
      return Ai(n), r.data = Ti.call(n, n.transformResponse, r), r.headers = Be.from(r.headers), r;
    },
    function(r) {
      return bc(r) || (Ai(n), r && r.response && (r.response.data = Ti.call(
        n,
        n.transformResponse,
        r.response
  ...
  _request(e, t) {
    ...
    this.interceptors.request.forEach(function(w) {
      if (typeof w.runWhen == "function" && w.runWhen(t) === !1)
        return;
      c = c && w.synchronous;
      const v = t.transitional || xo;
      v && v.legacyInterceptorReqResOrdering ? a.unshift(w.fulfilled, w.rejected) : a.push(w.fulfilled, w.rejected);
    });
    const u = [];
...
let yb = class Tc {
  constructor(e) {
    ...
    this.promise.then((s) => {
      ...
      r.reason || (r.reason = new Tr(i, o, a), t(r.reason));
    });
  }
  /**
...
function Ao({
  ...
  const g = $r(() => Eb(n, d), [n, d]), p = $r(() => xb(g), [g]), w = $r(
    () => ({
      currentUserFullName: e,
      defaultToEmails: t,
      referenceName: r,
    ...
    () => ({
      sendEmail: async (N) => {
        var C;
        try {
          const q = (await p.sendEmail(N)).data;
          if (q != null && q._server_messages)
            try {
              const G = JSON.parse(q._server_messages);
              if (Array.isArray(G) && G.length > 0) {
                const z = JSON.parse(G[0]);
                if (z.message)
                  return m == null || m(z.title || "Error", z.message), {};
              }
            } catch {
              if (q != null && q.exception)
                return m == null || m("Error", q.exception), {};
            }
          else if (q != null && q.exception)
            return m == null || m("Error", q.exception), {};
          const j = ((C = q == null ? void 0 : q.data) == null ? void 0 : C.message) || (q == null ? void 0 : q.message) || q;
          return { name: j == null ? void 0 : j.name };
        } catch {
      ...
      uploadFile: async (N) => {
        var j;
        const L = (await p.uploadFile(N)).data, q = ((j = L == null ? void 0 : L.data) == null ? void 0 : j.message) || (L == null ? void 0 : L.message) || L;
        return { name: q == null ? void 0 : q.name, file_url: q == null ? void 0 : q.file_url };
      },
      getTemplates: async () => {
        var L;
        return (((L = (await p.getTemplates()).data) == null ? void 0 : L.message) || []).map((q) => ({
          id: q.name,
          name: q.subject || q.name,
          body: q.response || q.response_html || ""
        }));
      },
      updateCommunicationStatus: async (N, C) => {
        await p.updateCommunication(N, C);
      },
      showNotification: (N, C) => u == null ? void 0 : u(N, C),
      showWarning: (N, C) => f == null ? void 0 : f(N, C),
      showError: (N, C) => m == null ? void 0 : m(N, C),
      onEmailSent: c
    }),
    [p, c, u, f, m]
  );
  return { config: w, apiAdapter: v };
}
function Nb(n) {
...
const Sc = ({
  ...
  var _t;
  const { config: C, apiAdapter: L } = Ao({
    baseURL: t,
    currentUserFullName: r,
    defaultToEmails: s,
    referenceName: i,
    ...
    setBccInput: B,
    attachments: H,
    isTemplateModalOpen: I,
    setIsTemplateModalOpen: K,
    fileUploadRef: ue,
    isPending: Q,
    emailTemplates: W,
    ...
    replyData: Z,
    // Handlers
    handleRecipientInputKeyDown: re,
    handleRecipientInputBlur: le,
    removeRecipient: ae,
    handleFileSelect: me,
    removeAttachment: ve,
    handleAttachClick: De,
    handleSend: Ge,
    handleTemplateSelect: Ut
  } = Fg({ apiAdapter: q, config: j, onClose: m, onSend: d });
  return /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer", children: [
    /* @__PURE__ */ _.jsx("div", { className: "ecw-email-composer-header", children: /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-from", children: [
      ...
      /* @__PURE__ */ _.jsx("span", { className: "ecw-email-composer-sender-name", children: ((_t = j.currentUserFullName) == null ? void 0 : _t.trim()) || "User" })
    ] }) }),
    ...
    /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-field", children: [
      ...
      /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-recipients-container", children: [
        /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-recipients", children: [
          ie.map((ne) => /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-tag", children: [
            /* @__PURE__ */ _.jsx("span", { children: ne.email }),
            /* @__PURE__ */ _.jsx("button", { type: "button", className: "ecw-email-composer-tag-remove", onClick: () => ae(ne.id, "to"), children: /* @__PURE__ */ _.jsx(Qn, { size: 14 }) })
          ] }, ne.id)),
          /* @__PURE__ */ _.jsx(
            "input",
            {
              type: "email",
              value: M,
              onChange: (ne) => U(ne.target.value),
              onKeyDown: (ne) => re(ne, "to"),
              onBlur: () => le("to"),
        ...
        /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-actions", children: [
          /* @__PURE__ */ _.jsx("button", { type: "button", className: "ecw-email-composer-cc-bcc-btn", onClick: () => R(!b), children: "CC" }),
          /* @__PURE__ */ _.jsx("button", { type: "button", className: "ecw-email-composer-cc-bcc-btn", onClick: () => P(!E), children: "BCC" })
        ] })
      ] })
    ] }),
    b && /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-field", children: [
      /* @__PURE__ */ _.jsx("span", { className: "ecw-email-composer-label", children: "CC:" }),
      /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-recipients", children: [
        oe.map((ne) => /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-tag", children: [
          /* @__PURE__ */ _.jsx("span", { children: ne.email }),
          /* @__PURE__ */ _.jsx("button", { type: "button", className: "ecw-email-composer-tag-remove", onClick: () => ae(ne.id, "cc"), children: /* @__PURE__ */ _.jsx(Qn, { size: 14 }) })
        ] }, ne.id)),
        /* @__PURE__ */ _.jsx(
          "input",
          {
            ...
            onKeyDown: (ne) => re(ne, "cc"),
            onBlur: () => le("cc"),
            placeholder: oe.length === 0 ? "Enter email address" : "",
            className: "ecw-email-composer-recipient-input"
          }
        )
      ] })
    ] }),
    E && /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-field", children: [
      /* @__PURE__ */ _.jsx("span", { className: "ecw-email-composer-label", children: "BCC:" }),
      /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-recipients", children: [
        pe.map((ne) => /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-tag", children: [
          /* @__PURE__ */ _.jsx("span", { children: ne.email }),
          /* @__PURE__ */ _.jsx("button", { type: "button", className: "ecw-email-composer-tag-remove", onClick: () => ae(ne.id, "bcc"), children: /* @__PURE__ */ _.jsx(Qn, { size: 14 }) })
        ] }, ne.id)),
        /* @__PURE__ */ _.jsx(
          "input",
          {
            ...
            onKeyDown: (ne) => re(ne, "bcc"),
            onBlur: () => le("bcc"),
            placeholder: pe.length === 0 ? "Enter email address" : "",
            className: "ecw-email-composer-recipient-input"
          }
        )
      ] })
    ...
    /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-body", children: [
      /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-editor-wrapper", children: [
        ...
        (Z == null ? void 0 : Z.content) && /* @__PURE__ */ _.jsxs("div", { className: "ecw-trail-email-preview", children: [
          ...
          /* @__PURE__ */ _.jsxs("div", { className: "ecw-trail-meta", children: [
            ...
            " ",
            Z.senderName || Z.to || "User",
            /* @__PURE__ */ _.jsx("br", {}),
            /* @__PURE__ */ _.jsx("b", { children: "Sent:" }),
            " ",
            Z.date && Z.time ? `${Z.date} at ${Z.time}` : "the previous message",
            /* @__PURE__ */ _.jsx("br", {}),
            /* @__PURE__ */ _.jsx("b", { children: "Subject:" }),
            " ",
            Z.subject || ""
          ] }),
          /* @__PURE__ */ _.jsx("div", { dangerouslySetInnerHTML: { __html: Nb(Z.content) } })
        ] })
      ] }),
      H.length > 0 && /* @__PURE__ */ _.jsx("div", { className: "ecw-email-composer-attachments", children: H.map((ne) => /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-attachment-tag", children: [
        /* @__PURE__ */ _.jsxs("span", { children: [
          ne.file.name,
          ne.isUploading && " (Uploading...)",
          ne.uploadError && ` (Error: ${ne.uploadError})`,
          ne.fileName && !ne.isUploading && !ne.uploadError && " ✓"
        ] }),
        /* @__PURE__ */ _.jsx("button", { type: "button", className: "ecw-email-composer-tag-remove", onClick: () => ve(ne.id), children: /* @__PURE__ */ _.jsx(Qn, { size: 14 }) })
      ] }, ne.id)) }),
      /* @__PURE__ */ _.jsx(Yl, { ref: ue, onSelect: me, multiple: !0, accept: "*/*" })
    ] }),
    /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-footer", children: [
      /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-footer-left", children: [
        /* @__PURE__ */ _.jsx("button", { type: "button", onClick: De, title: "Attach file", className: "ecw-email-composer-icon-btn", children: /* @__PURE__ */ _.jsx(Kc, { size: 20, color: "#175353" }) }),
        /* @__PURE__ */ _.jsx(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ _.jsxs("div", { className: "ecw-email-composer-footer-right", children: [
        /* @__PURE__ */ _.jsx("button", { type: "button", onClick: m, className: "ecw-email-composer-btn ecw-email-composer-btn-secondary", disabled: Q, children: "Cancel" }),
        /* @__PURE__ */ _.jsx("button", { type: "button", onClick: Ge, className: "ecw-email-composer-btn ecw-email-composer-btn-primary", disabled: Q, children: Q ? "Sending..." : "Send" })
      ] })
    ] }),
    /* @__PURE__ */ _.jsx(
      Qi,
      {
        ...
        children: /* @__PURE__ */ _.jsx(Zc, { templates: W, onSelect: Ut, isLoading: te })
      }
    )
  ] });
}, Yb = ({
  ...
  RichTextEditor: C,
  modalSize: L = "800px",
  header: q = /* @__PURE__ */ _.jsx("h3", { style: { margin: 0, fontSize: "1.1rem" }, children: "Email Composer" })
}) => {
  const { config: j, apiAdapter: G } = Ao({
    baseURL: t,
    currentUserFullName: r,
    defaultToEmails: s,
    referenceName: i,
  ...
  const [G, z] = Oe(!1), { config: ie, apiAdapter: oe } = Ao({
    baseURL: t,
    currentUserFullName: r,
    defaultToEmails: s,
    referenceName: i,
    ...
    showError: q,
    token: j
  }), pe = n || oe, b = e || ie, R = p !== void 0, E = R ? p : G, P = () => {
    w ? w() : R || z(!0);
  }, k = () => {
    v ? v() : R || z(!1);
  };
  return /* @__PURE__ */ _.jsxs(_.Fragment, { children: [
    /* @__PURE__ */ _.jsxs("div", { className: `ecw-trigger-button ${d}`, onClick: P, children: [
      /* @__PURE__ */ _.jsx("div", { className: "ecw-trigger-icon-wrapper", children: /* @__PURE__ */ _.jsx(Gc, { size: 20, color: "#175353" }) }),
      /* @__PURE__ */ _.jsx("span", { className: "ecw-trigger-label", children: m })
    ] }),
    /* @__PURE__ */ _.jsx(
      Qi,
      {
        ...
        children: /* @__PURE__ */ _.jsx(Sc, { apiAdapter: pe, config: b, RichTextEditor: f, onClose: k })
      }
    )
  ] });
}, _c = jc(void 0), Qb = ({
  ...
  RichTextEditor: t,
  children: r
}) => /* @__PURE__ */ _.jsx(_c.Provider, { value: { apiAdapter: n, config: e, RichTextEditor: t }, children: r }), e0 = () => {
  const n = kc(_c);

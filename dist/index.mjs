...
function Fc() {
  return Oo || (Oo = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function t(x) {
      ...
      if (j) {
        j = console;
        var H = j.error, k = typeof Symbol == "function" && Symbol.toStringTag && x[Symbol.toStringTag] || x.constructor.name || "Object";
        return H.call(
          j,
    ...
    function c() {
      var x = n(this.type);
      return B[x] || (B[x] = !0, console.error(
        "Accessing element.ref was removed in React 19. ref is now a regular prop. It will be removed from the JSX Element type in a future release."
      )), x = this.props.ref, x !== void 0 ? x : null;
    }
    function u(x, j, H, k, K, ce) {
      var te = H.ref;
      return x = {
        $$typeof: p,
        type: x,
    ...
    function f(x, j, H, k, K, ce) {
      ...
      if (E.call(j, "key")) {
        te = n(x);
        var W = Object.keys(j).filter(function(ne) {
          return ne !== "key";
        });
        k = 0 < W.length ? "{key: someKey, " + W.join(": ..., ") + ": ...}" : "{key: someKey}", U[te + k] || (W = 0 < W.length ? "{" + W.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (te = null, H !== void 0 && (t(H), te = "" + H), o(j) && (t(j.key), te = "" + j.key), "key" in j) {
        H = {};
        for (var Y in j)
          Y !== "key" && (H[Y] = j[Y]);
      } else H = j;
    ...
    var y = Rc, p = Symbol.for("react.transitional.element"), v = Symbol.for("react.portal"), w = Symbol.for("react.fragment"), A = Symbol.for("react.strict_mode"), R = Symbol.for("react.profiler"), L = Symbol.for("react.consumer"), D = Symbol.for("react.context"), _ = Symbol.for("react.forward_ref"), F = Symbol.for("react.suspense"), G = Symbol.for("react.suspense_list"), re = Symbol.for("react.memo"), le = Symbol.for("react.lazy"), de = Symbol.for("react.activity"), g = Symbol.for("react.client.reference"), q = y.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, E = Object.prototype.hasOwnProperty, P = Array.isArray, I = console.createTask ? console.createTask : function() {
      return null;
    };
    y = {
    ...
    var N, B = {}, M = y.react_stack_bottom_frame.bind(
      y,
      i
    )(), z = I(r(i)), U = {};
...
function wh(n) {
  return Tt(n) && ra(n.length) && !!be[kn(n)];
}
function ro(n) {
  return function(e) {
    return n(e);
...
var Ah = aa(Object.keys, Object), Nh = Object.prototype, Sh = Nh.hasOwnProperty;
function _h(n) {
  if (!no(n))
    return Ah(n);
  var e = [];
...
var Ci = nn(gt, "DataView"), Ri = nn(gt, "Promise"), Li = nn(gt, "Set"), Fo = "[object Map]", Af = "[object Object]", Ho = "[object Promise]", zo = "[object Set]", Ko = "[object WeakMap]", Vo = "[object DataView]", Nf = tn(Ci), Sf = tn(ur), _f = tn(Ri), Of = tn(Li), Cf = tn(Si), Qe = kn;
(Ci && Qe(new Ci(new ArrayBuffer(1))) != Vo || ur && Qe(new ur()) != Fo || Ri && Qe(Ri.resolve()) != Ho || Li && Qe(new Li()) != zo || Si && Qe(new Si()) != Ko) && (Qe = function(n) {
  var e = kn(n), t = e == Af ? n.constructor : void 0, r = t ? tn(t) : "";
  if (r)
    switch (r) {
      case Nf:
        return Vo;
...
var Jo = _n && _n.isSet, ad = Jo ? ro(Jo) : ld, cd = 1, ga = "[object Arguments]", ud = "[object Array]", hd = "[object Boolean]", fd = "[object Date]", dd = "[object Error]", ba = "[object Function]", pd = "[object GeneratorFunction]", md = "[object Map]", gd = "[object Number]", ya = "[object Object]", bd = "[object RegExp]", yd = "[object Set]", vd = "[object String]", wd = "[object Symbol]", Ed = "[object WeakMap]", xd = "[object ArrayBuffer]", Td = "[object DataView]", Ad = "[object Float32Array]", Nd = "[object Float64Array]", Sd = "[object Int8Array]", _d = "[object Int16Array]", Od = "[object Int32Array]", Cd = "[object Uint8Array]", Rd = "[object Uint8ClampedArray]", Ld = "[object Uint16Array]", qd = "[object Uint32Array]", pe = {};
pe[ga] = pe[ud] = pe[xd] = pe[Td] = pe[hd] = pe[fd] = pe[Ad] = pe[Nd] = pe[Sd] = pe[_d] = pe[Od] = pe[md] = pe[gd] = pe[ya] = pe[bd] = pe[yd] = pe[vd] = pe[wd] = pe[Cd] = pe[Rd] = pe[Ld] = pe[qd] = !0;
pe[dd] = pe[ba] = pe[Ed] = !1;
...
function lp(n, e, t, r, s, i) {
  ...
  for (var w = o; ++m < c; ) {
    ...
    var A = n[d], R = e[d];
    if (r)
      var L = o ? r(R, A, d, e, n, i) : r(A, R, d, n, e, i);
    if (!(L === void 0 ? A === R || s(A, R, t, r, i) : L)) {
      v = !1;
      break;
    }
    w || (w = d == "constructor");
  ...
  if (v && !w) {
    var D = n.constructor, _ = e.constructor;
    D != _ && "constructor" in n && "constructor" in e && !(typeof D == "function" && D instanceof D && typeof _ == "function" && _ instanceof _) && (v = !1);
  }
...
function mp(n, e, t, r, s, i, o) {
  ...
  if (m) {
    ...
    f = c, d || y || p ? Yt(a) ? f = a : dp(a) ? f = Tu(a) : y ? (m = !1, f = da(c, !0)) : p ? (m = !1, f = pa(c, !0)) : f = [] : uf(c) || _i(c) ? (f = a, _i(a) ? f = pp(a) : (!Dt(a) || eo(a)) && (f = ma(c))) : m = !1;
  }
...
var Pt = $u(function(n, e, t) {
  Ea(n, e, t);
}), J = /* @__PURE__ */ ((n) => (n[n.TYPE = 3] = "TYPE", n[n.LEVEL = 12] = "LEVEL", n[n.ATTRIBUTE = 13] = "ATTRIBUTE", n[n.BLOT = 14] = "BLOT", n[n.INLINE = 7] = "INLINE", n[n.BLOCK = 11] = "BLOCK", n[n.BLOCK_BLOT = 10] = "BLOCK_BLOT", n[n.INLINE_BLOT = 6] = "INLINE_BLOT", n[n.BLOCK_ATTRIBUTE = 9] = "BLOCK_ATTRIBUTE", n[n.INLINE_ATTRIBUTE = 5] = "INLINE_ATTRIBUTE", n[n.ANY = 15] = "ANY", n))(J || {});
class pt {
  constructor(e, t, r = {}) {
    this.attrName = e, this.keyName = t;
    const s = J.TYPE & J.ATTRIBUTE;
    this.scope = r.scope != null ? (
      // Ignore type bits, force attribute bit
      r.scope & J.LEVEL | s
    ) : J.ATTRIBUTE, r.whitelist != null && (this.whitelist = r.whitelist);
  }
  static keys(e) {
...
const xa = class Ii {
  ...
  create(e, t, r) {
    ...
    if (s == null)
      throw new Nn(`Unable to create ${t} blot`);
    const i = s, o = (
  ...
  query(e, t = J.ANY) {
    let r;
    return typeof e == "string" ? r = this.types[e] || this.attributes[e] : e instanceof Text || e.nodeType === Node.TEXT_NODE ? r = this.types.text : typeof e == "number" ? e & J.LEVEL & J.BLOCK ? r = this.types.block : e & J.LEVEL & J.INLINE && (r = this.types.inline) : e instanceof Element && ((e.getAttribute("class") || "").split(/\s+/).some((s) => (r = this.classes[s], !!r)), r = r || this.tags[e.tagName]), r == null ? null : "scope" in r && t & J.LEVEL & r.scope && t & J.TYPE & r.scope ? r : null;
  }
  register(...e) {
    return e.map((t) => {
      const r = "blotName" in t, s = "attrName" in t;
      if (!r && !s)
        throw new Nn("Invalid definition");
      if (r && t.blotName === "abstract")
        throw new Nn("Cannot register abstract class");
...
class yp {
  ...
  build() {
    ...
    if (e == null)
      return;
    const t = pt.keys(this.domNode), r = rt.keys(this.domNode), s = Ut.keys(this.domNode);
    t.concat(r).concat(s).forEach((i) => {
      const o = e.scroll.query(i, J.ATTRIBUTE);
...
const ps = yp, Ta = class {
  ...
  static create(e) {
    if (this.tagName == null)
      throw new Nn("Blot definition missing tagName");
    let t, r;
  ...
  formatAt(e, t, r, s) {
    ...
    if (this.scroll.query(r, J.BLOT) != null && s)
      i.wrap(r, s);
    else if (this.scroll.query(r, J.ATTRIBUTE) != null) {
  ...
  wrap(e, t) {
    ...
    if (this.parent != null && this.parent.insertBefore(r, this.next || void 0), typeof r.appendChild != "function")
      throw new Nn(`Cannot wrap ${e}`);
    return r.appendChild(this), r;
  }
};
Ta.blotName = "abstract";
let Aa = Ta;
const Na = class extends Aa {
  /**
...
const Sa = class kt extends Aa {
  ...
  attachUI(e) {
    this.uiNode != null && this.uiNode.remove(), this.uiNode = e, kt.uiClass && this.uiNode.classList.add(kt.uiClass), this.uiNode.setAttribute("contenteditable", "false"), this.domNode.insertBefore(this.uiNode, this.domNode.firstChild);
  }
  /**
  ...
  descendant(e, t = 0) {
    ...
    return e.blotName == null && e(r) || e.blotName != null && r instanceof e ? [r, s] : r instanceof kt ? r.descendant(e, s) : [null, -1];
  }
  descendants(e, t = 0, r = Number.MAX_VALUE) {
    ...
    return this.children.forEachAt(
      ...
      r,
      (o, a, c) => {
        (e.blotName == null && e(o) || e.blotName != null && o instanceof e) && s.push(o), o instanceof kt && (s = s.concat(
          o.descendants(e, a, i)
        )), i -= c;
      }
    ), s;
  ...
  enforceAllowedChildren() {
    ...
    this.children.forEach((t) => {
      e || this.statics.allowedChildren.some(
        (r) => t instanceof r
      ) || (t.statics.scope === J.BLOCK_BLOT ? (t.next != null && this.splitAfter(t), t.prev != null && this.splitAfter(t.prev), t.parent.unwrap(), e = !0) : t instanceof kt ? t.unwrap() : t.remove());
    });
  }
  formatAt(e, t, r, s) {
  ...
  path(e, t = !1) {
    ...
    return r instanceof kt ? i.concat(r.path(s, t)) : (r != null && i.push([r, s]), i);
  }
  removeChild(e) {
  ...
  replaceWith(e, t) {
    const r = typeof e == "string" ? this.scroll.create(e, t) : e;
    return r instanceof kt && this.moveChildren(r), super.replaceWith(r);
  }
  split(e, t = !1) {
    if (!t) {
      if (e === 0)
...
const bn = class yn extends tt {
  ...
  format(e, t) {
    if (e === this.statics.blotName && !t)
      ...
      const r = this.scroll.query(e, J.INLINE);
      if (r == null)
        return;
  ...
  formatAt(e, t, r, s) {
    this.formats()[r] != null || this.scroll.query(r, J.ATTRIBUTE) ? this.isolate(e, t).format(r, s) : super.formatAt(e, t, r, s);
  }
  optimize(e) {
    super.optimize(e);
...
bn.allowedChildren = [bn, Ce], bn.blotName = "inline", bn.scope = J.INLINE_BLOT, bn.tagName = "SPAN";
let Tp = bn;
const lo = Tp, vn = class ji extends tt {
  ...
  format(e, t) {
    const r = this.scroll.query(e, J.BLOCK);
  ...
  formatAt(e, t, r, s) {
    this.scroll.query(r, J.BLOCK) != null ? this.format(r, s) : super.formatAt(e, t, r, s);
  }
  insertAt(e, t, r) {
    if (r == null || this.scroll.query(t, J.INLINE) != null)
...
vn.blotName = "block", vn.scope = J.BLOCK_BLOT, vn.tagName = "P", vn.allowedChildren = [
  lo,
  vn,
  Ce
];
let Ap = vn;
const hr = Ap, Bi = class extends tt {
  checkMerge() {
...
Bi.blotName = "container", Bi.scope = J.BLOCK_BLOT;
let Np = Bi;
const ms = Np;
class Sp extends Ce {
  static formats(e, t) {
...
wn.blotName = "scroll", wn.defaultChild = hr, wn.allowedChildren = [hr, ms], wn.scope = J.BLOCK_BLOT, wn.tagName = "DIV";
let Cp = wn;
...
Pi.blotName = "text", Pi.scope = J.INLINE_BLOT;
let Rp = Pi;
...
function qp() {
  ...
  function r(g, q, E, P, I) {
    ...
    var B = a(g, q), M = g.substring(0, B);
    g = g.substring(B), q = q.substring(B), B = u(g, q);
    var z = g.substring(g.length - B);
    g = g.substring(0, g.length - B), q = q.substring(0, q.length - B);
    var U = s(g, q);
    return M && U.unshift([t, M]), z && U.push([t, z]), R(U, I), P && m(U), U;
  }
  function s(g, q) {
    var E;
    if (!g)
    ...
    if (!q)
      return [[n, g]];
    var P = g.length > q.length ? g : q, I = g.length > q.length ? q : g, N = P.indexOf(I);
    if (N !== -1)
      return E = [
        [e, P.substring(0, N)],
        [t, I],
        [e, P.substring(N + I.length)]
      ], g.length > q.length && (E[0][0] = E[2][0] = n), E;
    if (I.length === 1)
      return [
        [n, g],
        [e, q]
    ...
    var B = f(g, q);
    if (B) {
      var M = B[0], z = B[1], U = B[2], x = B[3], j = B[4], H = r(M, U), k = r(z, x);
      return H.concat([[t, j]], k);
    }
    return i(g, q);
  }
  function i(g, q) {
    for (var E = g.length, P = q.length, I = Math.ceil((E + P) / 2), N = I, B = 2 * I, M = new Array(B), z = new Array(B), U = 0; U < B; U++)
      M[U] = -1, z[U] = -1;
    M[N + 1] = 0, z[N + 1] = 0;
    for (var x = E - P, j = x % 2 !== 0, H = 0, k = 0, K = 0, ce = 0, te = 0; te < I; te++) {
      for (var W = -te + H; W <= te - k; W += 2) {
        var Y = N + W, ne;
        W === -te || W !== te && M[Y - 1] < M[Y + 1] ? ne = M[Y + 1] : ne = M[Y - 1] + 1;
        for (var Q = ne - W; ne < E && Q < P && g.charAt(ne) === q.charAt(Q); )
          ne++, Q++;
        if (M[Y] = ne, ne > E)
          k += 2;
        else if (Q > P)
      ...
      for (var me = -te + K; me <= te - ce; me += 2) {
        var oe = N + me, ae;
        me === -te || me !== te && z[oe - 1] < z[oe + 1] ? ae = z[oe + 1] : ae = z[oe - 1] + 1;
        for (var ve = ae - me; ae < E && ve < P && g.charAt(E - ae - 1) === q.charAt(P - ve - 1); )
          ae++, ve++;
        if (z[oe] = ae, ae > E)
          ce += 2;
        else if (ve > P)
  ...
  function o(g, q, E, P) {
    var I = g.substring(0, E), N = q.substring(0, P), B = g.substring(E), M = q.substring(P), z = r(I, N), U = r(B, M);
    return z.concat(U);
  }
  function a(g, q) {
    if (!g || !q || g.charAt(0) !== q.charAt(0))
      return 0;
    for (var E = 0, P = Math.min(g.length, q.length), I = P, N = 0; E < I; )
      g.substring(N, I) == q.substring(N, I) ? (E = I, N = E) : P = I, I = Math.floor((P - E) / 2 + E);
    return L(g.charCodeAt(I - 1)) && I--, I;
  }
  function c(g, q) {
    var E = g.length, P = q.length;
    if (E == 0 || P == 0)
      return 0;
    E > P ? g = g.substring(E - P) : E < P && (q = q.substring(0, E));
    var I = Math.min(E, P);
    if (g == q)
      return I;
    for (var N = 0, B = 1; ; ) {
      var M = g.substring(I - B), z = q.indexOf(M);
      if (z == -1)
        return N;
      B += z, (z == 0 || g.substring(I - B) == q.substring(0, B)) && (N = B, B++);
    }
  }
  function u(g, q) {
    if (!g || !q || g.slice(-1) !== q.slice(-1))
      return 0;
    for (var E = 0, P = Math.min(g.length, q.length), I = P, N = 0; E < I; )
      g.substring(g.length - I, g.length - N) == q.substring(q.length - I, q.length - N) ? (E = I, N = E) : P = I, I = Math.floor((P - E) / 2 + E);
    return D(g.charCodeAt(g.length - I)) && I--, I;
  }
  function f(g, q) {
    var E = g.length > q.length ? g : q, P = g.length > q.length ? q : g;
    if (E.length < 4 || P.length * 2 < E.length)
      return null;
    function I(k, K, ce) {
      for (var te = k.substring(ce, ce + Math.floor(k.length / 4)), W = -1, Y = "", ne, Q, oe, ae; (W = K.indexOf(te, W + 1)) !== -1; ) {
        var me = a(
          k.substring(ce),
          K.substring(W)
        ), ve = u(
        ...
        Y.length < ve + me && (Y = K.substring(W - ve, W) + K.substring(W, W + me), ne = k.substring(0, ce - ve), Q = k.substring(ce + me), oe = K.substring(0, W - ve), ae = K.substring(W + me));
      }
      return Y.length * 2 >= k.length ? [
        ne,
        Q,
        oe,
        ae,
    ...
    if (!N && !B)
      return null;
    B ? N ? M = N[4].length > B[4].length ? N : B : M = B : M = N;
    var z, U, x, j;
    g.length > q.length ? (z = M[0], U = M[1], x = M[2], j = M[3]) : (x = M[0], j = M[1], z = M[2], U = M[3]);
    var H = M[4];
    return [z, U, x, j, H];
  }
  function m(g) {
    for (var q = !1, E = [], P = 0, I = null, N = 0, B = 0, M = 0, z = 0, U = 0; N < g.length; )
      g[N][0] == t ? (E[P++] = N, B = z, M = U, z = 0, U = 0, I = g[N][1]) : (g[N][0] == e ? z += g[N][1].length : U += g[N][1].length, I && I.length <= Math.max(B, M) && I.length <= Math.max(z, U) && (g.splice(E[P - 1], 0, [
        n,
        I
      ]), g[E[P - 1] + 1][0] = e, P--, P--, N = P > 0 ? E[P - 1] : -1, B = 0, M = 0, z = 0, U = 0, I = null, q = !0)), N++;
    for (q && R(g), A(g), N = 1; N < g.length; ) {
      if (g[N - 1][0] == n && g[N][0] == e) {
        var x = g[N - 1][1], j = g[N][1], H = c(x, j), k = c(j, x);
        H >= k ? (H >= x.length / 2 || H >= j.length / 2) && (g.splice(N, 0, [
          t,
          j.substring(0, H)
        ]), g[N - 1][1] = x.substring(
          0,
          x.length - H
        ), g[N + 1][1] = j.substring(H), N++) : (k >= x.length / 2 || k >= j.length / 2) && (g.splice(N, 0, [
          t,
          x.substring(0, k)
        ]), g[N - 1][0] = e, g[N - 1][1] = j.substring(
          0,
          j.length - k
        ), g[N + 1][0] = n, g[N + 1][1] = x.substring(k), N++), N++;
      }
      N++;
    }
  }
  ...
  function A(g) {
    function q(k, K) {
      if (!k || !K)
        return 6;
      var ce = k.charAt(k.length - 1), te = K.charAt(0), W = ce.match(d), Y = te.match(d), ne = W && ce.match(y), Q = Y && te.match(y), oe = ne && ce.match(p), ae = Q && te.match(p), me = oe && k.match(v), ve = ae && K.match(w);
      return me || ve ? 5 : oe || ae ? 4 : W && !ne && Q ? 3 : ne || Q ? 2 : W || Y ? 1 : 0;
    }
    for (var E = 1; E < g.length - 1; ) {
      if (g[E - 1][0] == t && g[E + 1][0] == t) {
        var P = g[E - 1][1], I = g[E][1], N = g[E + 1][1], B = u(P, I);
        if (B) {
          var M = I.substring(I.length - B);
          P = P.substring(0, P.length - B), I = M + I.substring(0, I.length - B), N = M + N;
        }
        for (var z = P, U = I, x = N, j = q(P, I) + q(I, N); I.charAt(0) === N.charAt(0); ) {
          P += I.charAt(0), I = I.substring(1) + N.charAt(0), N = N.substring(1);
          var H = q(P, I) + q(I, N);
          H >= j && (j = H, z = P, U = I, x = N);
        }
        g[E - 1][1] != z && (z ? g[E - 1][1] = z : (g.splice(E - 1, 1), E--), g[E][1] = U, x ? g[E + 1][1] = x : (g.splice(E + 1, 1), E--));
      }
      E++;
    }
  }
  function R(g, q) {
    g.push([t, ""]);
    for (var E = 0, P = 0, I = 0, N = "", B = "", M; E < g.length; ) {
      ...
      switch (g[E][0]) {
        ...
        case t:
          ...
          if (q) {
            if (z >= 0 && F(g[z][1])) {
              ...
              if (g[z][1] = g[z][1].slice(
                ...
                g.splice(z, 1), E--;
                var x = z - 1;
                g[x] && g[x][0] === e && (I++, B = g[x][1] + B, x--), g[x] && g[x][0] === n && (P++, N = g[x][1] + N, x--), z = x;
              }
            }
            if (_(g[E][1])) {
              var U = g[E][1].charAt(0);
              g[E][1] = g[E][1].slice(1), N += U, B += U;
            }
          }
          if (E < g.length - 1 && !g[E][1]) {
            g.splice(E, 1);
          ...
          if (N.length > 0 || B.length > 0) {
            N.length > 0 && B.length > 0 && (M = a(B, N), M !== 0 && (z >= 0 ? g[z][1] += B.substring(
              0,
              M
            ) : (g.splice(0, 0, [
              t,
              B.substring(0, M)
            ]), E++), B = B.substring(M), N = N.substring(M)), M = u(B, N), M !== 0 && (g[E][1] = B.substring(B.length - M) + g[E][1], B = B.substring(
              0,
              B.length - M
            ), N = N.substring(
              0,
            ...
            var j = I + P;
            N.length === 0 && B.length === 0 ? (g.splice(E - j, j), E = E - j) : N.length === 0 ? (g.splice(E - j, j, [e, B]), E = E - j + 1) : B.length === 0 ? (g.splice(E - j, j, [n, N]), E = E - j + 1) : (g.splice(
              E - j,
              j,
              [n, N],
              [e, B]
          ...
          E !== 0 && g[E - 1][0] === t ? (g[E - 1][1] += g[E][1], g.splice(E, 1)) : E++, I = 0, P = 0, N = "", B = "";
          break;
      }
    }
  ...
  function F(g) {
    return L(g.charCodeAt(g.length - 1));
  }
  function G(g) {
    for (var q = [], E = 0; E < g.length; E++)
      g[E][1].length > 0 && q.push(g[E]);
    return q;
  }
  function re(g, q, E, P) {
    return F(g) || _(P) ? null : G([
      [t, g],
      [n, q],
      [e, E],
      [t, P]
  ...
  function le(g, q, E) {
    var P = typeof E == "number" ? { index: E, length: 0 } : E.oldRange, I = typeof E == "number" ? null : E.newRange, N = g.length, B = q.length;
    if (P.length === 0 && (I === null || I.length === 0)) {
      var M = P.index, z = g.slice(0, M), U = g.slice(M), x = I ? I.index : null;
      e: {
        var j = M + B - N;
        if (x !== null && x !== j || j < 0 || j > B)
          break e;
        var H = q.slice(0, j), k = q.slice(j);
        if (k !== U)
          break e;
        var K = Math.min(M, j), ce = z.slice(0, K), te = H.slice(0, K);
        if (ce !== te)
          break e;
        var W = z.slice(K), Y = H.slice(K);
        return re(ce, W, Y, U);
      }
      e: {
        if (x !== null && x !== M)
          break e;
        var ne = M, H = q.slice(0, ne), k = q.slice(ne);
        if (H !== z)
          break e;
        var Q = Math.min(N - ne, B - ne), oe = U.slice(U.length - Q), ae = k.slice(k.length - Q);
        if (oe !== ae)
          break e;
        var W = U.slice(0, U.length - Q), Y = k.slice(0, k.length - Q);
        return re(z, W, Y, oe);
      }
    }
    if (P.length > 0 && I && I.length === 0)
      e: {
        var ce = g.slice(0, P.index), oe = g.slice(P.index + P.length), K = ce.length, Q = oe.length;
        if (B < K + Q)
          break e;
        var te = q.slice(0, K), ae = q.slice(B - Q);
        if (ce !== te || oe !== ae)
          break e;
        var W = g.slice(K, N - Q), Y = q.slice(K, B - Q);
        return re(ce, W, Y, oe);
      }
    return null;
  }
...
function Oa() {
  return sl || (sl = 1, (function(n, e) {
    var t = 200, r = "__lodash_hash_undefined__", s = 9007199254740991, i = "[object Arguments]", o = "[object Array]", a = "[object Boolean]", c = "[object Date]", u = "[object Error]", f = "[object Function]", m = "[object GeneratorFunction]", d = "[object Map]", y = "[object Number]", p = "[object Object]", v = "[object Promise]", w = "[object RegExp]", A = "[object Set]", R = "[object String]", L = "[object Symbol]", D = "[object WeakMap]", _ = "[object ArrayBuffer]", F = "[object DataView]", G = "[object Float32Array]", re = "[object Float64Array]", le = "[object Int8Array]", de = "[object Int16Array]", g = "[object Int32Array]", q = "[object Uint8Array]", E = "[object Uint8ClampedArray]", P = "[object Uint16Array]", I = "[object Uint32Array]", N = /[\\^$.*+?()[\]{}|]/g, B = /\w*$/, M = /^\[object .+?Constructor\]$/, z = /^(?:0|[1-9]\d*)$/, U = {};
    U[i] = U[o] = U[_] = U[F] = U[a] = U[c] = U[G] = U[re] = U[le] = U[de] = U[g] = U[d] = U[y] = U[p] = U[w] = U[A] = U[R] = U[L] = U[q] = U[E] = U[P] = U[I] = !0, U[u] = U[f] = U[D] = !1;
    var x = typeof It == "object" && It && It.Object === Object && It, j = typeof self == "object" && self && self.Object === Object && self, H = x || j || Function("return this")(), k = e && !e.nodeType && e, K = k && !0 && n && !n.nodeType && n, ce = K && K.exports === k;
    function te(l, h) {
    ...
    function ne(l, h) {
      for (var b = -1, S = h.length, ie = l.length; ++b < S; )
        l[ie + b] = h[b];
      return l;
    }
    function Q(l, h, b, S) {
      for (var ie = -1, X = l ? l.length : 0; ++ie < X; )
        b = h(b, l[ie], ie, l);
      return b;
    }
    function oe(l, h) {
    ...
    function ve(l) {
      ...
      return l.forEach(function(S, ie) {
        b[++h] = [ie, S];
      }), b;
    }
    function De(l, h) {
    ...
    var Ot = Array.prototype, se = Function.prototype, Ue = Object.prototype, Ct = H["__core-js_shared__"], $t = (function() {
      var l = /[^.]+$/.exec(Ct && Ct.keys && Ct.keys.IE_PROTO || "");
      return l ? "Symbol(src)_1." + l : "";
    })(), Ft = se.toString, Pe = Ue.hasOwnProperty, bt = Ue.toString, an = RegExp(
      "^" + Ft.call(Pe).replace(N, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
    ), lt = ce ? H.Buffer : void 0, ge = H.Symbol, Rt = H.Uint8Array, $e = De(Object.getPrototypeOf, Object), Nr = Object.create, Sr = Ue.propertyIsEnumerable, As = Ot.splice, jn = Object.getOwnPropertySymbols, cn = lt ? lt.isBuffer : void 0, _r = De(Object.keys, Object), un = Je(H, "DataView"), Ht = Je(H, "Map"), Ze = Je(H, "Promise"), hn = Je(H, "Set"), Bn = Je(H, "WeakMap"), zt = Je(Object, "create"), Pn = qe(un), Kt = qe(Ht), Mn = qe(Ze), Dn = qe(hn), Un = qe(Bn), Lt = ge ? ge.prototype : void 0, Or = Lt ? Lt.valueOf : void 0;
    function yt(l) {
    ...
    yt.prototype.clear = Ns, yt.prototype.delete = Ss, yt.prototype.get = _s, yt.prototype.has = Cr, yt.prototype.set = $n;
    function xe(l) {
      var h = -1, b = l ? l.length : 0;
      for (this.clear(); ++h < b; ) {
        var S = l[h];
    ...
    Ne.prototype.clear = ks, Ne.prototype.delete = Is, Ne.prototype.get = js, Ne.prototype.has = Bs, Ne.prototype.set = Ps;
    function ke(l) {
    ...
    function fn(l, h) {
      var b = Kn(l) || mn(l) ? oe(l.length, String) : [], S = b.length, ie = !!S;
      for (var X in l)
        Pe.call(l, X) && !(ie && (X == "length" || ni(X, S))) && b.push(X);
      return b;
    }
    function Rr(l, h, b) {
      var S = l[h];
    ...
    function Fn(l, h, b, S, ie, X, he) {
      var ue;
      if (S && (ue = X ? S(l, ie, X, he) : S(l)), ue !== void 0)
        return ue;
      if (!ut(l))
        return l;
      var we = Kn(l);
    ...
    function Hn(l) {
      ...
      return new Rt(h).set(new Rt(l)), h;
    }
    function Vt(l, h) {
    ...
    function Lr(l, h, b) {
      ...
      return Q(S, te, new l.constructor());
    }
    function qr(l) {
      var h = new l.constructor(l.source, B.exec(l));
      return h.lastIndex = l.lastIndex, h;
    }
    function Ws(l, h, b) {
      var S = h ? b(We(l), !0) : We(l);
      return Q(S, W, new l.constructor());
    }
    function Zs(l) {
    ...
    function zn(l, h, b, S) {
      b || (b = {});
      for (var ie = -1, X = h.length; ++ie < X; ) {
        var he = h[ie], ue = void 0;
    ...
    var vt = jn ? De(jn, Object) : oi, wt = Ks;
    (un && wt(new un(new ArrayBuffer(1))) != F || Ht && wt(new Ht()) != d || Ze && wt(Ze.resolve()) != v || hn && wt(new hn()) != A || Bn && wt(new Bn()) != D) && (wt = function(l) {
      var h = bt.call(l), b = h == p ? l.constructor : void 0, S = b ? qe(b) : void 0;
      if (S)
        switch (S) {
          case Pn:
            return F;
    ...
    function mn(l) {
      return ii(l) && Pe.call(l, "callee") && (!Sr.call(l, "callee") || bt.call(l) == i);
    }
...
function Ca() {
  return il || (il = 1, (function(n, e) {
    var t = 200, r = "__lodash_hash_undefined__", s = 1, i = 2, o = 9007199254740991, a = "[object Arguments]", c = "[object Array]", u = "[object AsyncFunction]", f = "[object Boolean]", m = "[object Date]", d = "[object Error]", y = "[object Function]", p = "[object GeneratorFunction]", v = "[object Map]", w = "[object Number]", A = "[object Null]", R = "[object Object]", L = "[object Promise]", D = "[object Proxy]", _ = "[object RegExp]", F = "[object Set]", G = "[object String]", re = "[object Symbol]", le = "[object Undefined]", de = "[object WeakMap]", g = "[object ArrayBuffer]", q = "[object DataView]", E = "[object Float32Array]", P = "[object Float64Array]", I = "[object Int8Array]", N = "[object Int16Array]", B = "[object Int32Array]", M = "[object Uint8Array]", z = "[object Uint8ClampedArray]", U = "[object Uint16Array]", x = "[object Uint32Array]", j = /[\\^$.*+?()[\]{}|]/g, H = /^\[object .+?Constructor\]$/, k = /^(?:0|[1-9]\d*)$/, K = {};
    K[E] = K[P] = K[I] = K[N] = K[B] = K[M] = K[z] = K[U] = K[x] = !0, K[a] = K[c] = K[g] = K[f] = K[q] = K[m] = K[d] = K[y] = K[v] = K[w] = K[R] = K[_] = K[F] = K[G] = K[de] = !1;
    var ce = typeof It == "object" && It && It.Object === Object && It, te = typeof self == "object" && self && self.Object === Object && self, W = ce || te || Function("return this")(), Y = e && !e.nodeType && e, ne = Y && !0 && n && !n.nodeType && n, Q = ne && ne.exports === Y, oe = Q && ce.process, ae = (function() {
      try {
    ...
    function ve(l, h) {
      for (var b = -1, S = l == null ? 0 : l.length, ie = 0, X = []; ++b < S; ) {
        var he = l[b];
        h(he, b, l) && (X[ie++] = he);
      }
      return X;
    ...
    var bt = Array.prototype, an = Function.prototype, lt = Object.prototype, ge = W["__core-js_shared__"], Rt = an.toString, $e = lt.hasOwnProperty, Nr = (function() {
      var l = /[^.]+$/.exec(ge && ge.keys && ge.keys.IE_PROTO || "");
      return l ? "Symbol(src)_1." + l : "";
    })(), Sr = lt.toString, As = RegExp(
      "^" + Rt.call($e).replace(j, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
    ), jn = Q ? W.Buffer : void 0, cn = W.Symbol, _r = W.Uint8Array, un = lt.propertyIsEnumerable, Ht = bt.splice, Ze = cn ? cn.toStringTag : void 0, hn = Object.getOwnPropertySymbols, Bn = jn ? jn.isBuffer : void 0, zt = Ft(Object.keys, Object), Pn = vt(W, "DataView"), Kt = vt(W, "Map"), Mn = vt(W, "Promise"), Dn = vt(W, "Set"), Un = vt(W, "WeakMap"), Lt = vt(Object, "create"), Or = qe(Pn), yt = qe(Kt), Ns = qe(Mn), Ss = qe(Dn), _s = qe(Un), Cr = cn ? cn.prototype : void 0, $n = Cr ? Cr.valueOf : void 0;
    function xe(l) {
    ...
    function Ls(l) {
      var h = this.__data__;
      return Lt ? h[l] !== void 0 : $e.call(h, l);
    }
    function qs(l, h) {
      var b = this.__data__;
    ...
    function Gs(l, h) {
      var b = mn(l), S = !b && jr(l), ie = !b && !S && gn(l), X = !b && !S && !ie && Mr(l), he = b || S || ie || X, ue = he ? Ot(l.length, String) : [], we = ue.length;
      for (var fe in l)
        ...
        ie && (fe == "offset" || fe == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
    ...
    function Vt(l) {
      return l == null ? l === void 0 ? le : A : Ze && Ze in Object(l) ? wt(l) : kr(l);
    }
    function Lr(l) {
      return ut(l) && Vt(l) == a;
    }
    function qr(l, h, b, S, ie) {
      return l === h ? !0 : l == null || h == null || !ut(l) && !ut(h) ? l !== l && h !== h : Ws(l, h, b, S, qr, ie);
    }
    function Ws(l, h, b, S, ie, X) {
      var he = mn(l), ue = mn(h), we = he ? c : ct(l), fe = ue ? c : ct(h);
      we = we == a ? R : we, fe = fe == a ? R : fe;
      var Se = we == R, Ie = fe == R, Ee = we == fe;
      if (Ee && gn(l)) {
        if (!gn(h))
          return !1;
        he = !0, Se = !1;
      ...
      if (Ee && !Se)
        return X || (X = new at()), he || Mr(l) ? zn(l, h, b, S, ie, X) : Xs(l, h, we, b, S, ie, X);
      if (!(b & s)) {
        var _e = Se && $e.call(l, "__wrapped__"), Te = Ie && $e.call(h, "__wrapped__");
        if (_e || Te) {
          var qt = _e ? l.value() : l, Et = Te ? h.value() : h;
          return X || (X = new at()), ie(qt, Et, b, S, X);
        }
      }
      return Ee ? (X || (X = new at()), Qs(l, h, b, S, ie, X)) : !1;
    }
    function Zs(l) {
      if (!Pr(l) || ri(l))
        return !1;
    ...
    function Js(l) {
      return ut(l) && Vn(l.length) && !!K[Vt(l)];
    }
    function Ys(l) {
      if (!si(l))
        return zt(l);
    ...
    function zn(l, h, b, S, ie, X) {
      ...
      for (X.set(l, h), X.set(h, l); ++Se < ue; ) {
        var _e = l[Se], Te = h[Se];
        if (S)
          var qt = he ? S(Te, _e, Se, h, l, X) : S(_e, Te, Se, l, h, X);
        if (qt !== void 0) {
          if (qt)
            continue;
          Ie = !1;
        ...
        if (Ee) {
          if (!We(h, function(Et, Wt) {
            if (!Ue(Ee, Wt) && (_e === Et || ie(_e, Et, b, S, X)))
              return Ee.push(Wt);
          })) {
            Ie = !1;
            break;
          }
        } else if (!(_e === Te || ie(_e, Te, b, S, X))) {
          Ie = !1;
          break;
        }
      }
      return X.delete(l), X.delete(h), Ie;
    }
    function Xs(l, h, b, S, ie, X, he) {
      switch (b) {
        case q:
    ...
    function Qs(l, h, b, S, ie, X) {
      ...
      for (var qt = he; ++Ie < we; ) {
        ...
        var Et = l[Ee], Wt = h[Ee];
        if (S)
          var So = he ? S(Wt, Et, Ee, h, l, X) : S(Et, Wt, Ee, l, h, X);
        if (!(So === void 0 ? Et === Wt || ie(Et, Wt, b, S, X) : So)) {
          Te = !1;
          break;
        }
      ...
      return X.delete(l), X.delete(h), Te;
    }
    function Gt(l) {
      return Hn(l, Gn, ei);
    }
    ...
    function wt(l) {
      ...
      var ie = Sr.call(l);
      return S && (h ? l[Ze] = b : delete l[Ze]), ie;
    }
    ...
    (Pn && ct(new Pn(new ArrayBuffer(1))) != q || Kt && ct(new Kt()) != v || Mn && ct(Mn.resolve()) != L || Dn && ct(new Dn()) != F || Un && ct(new Un()) != de) && (ct = function(l) {
      var h = Vt(l), b = h == R ? l.constructor : void 0, S = b ? qe(b) : "";
      if (S)
        switch (S) {
          case Or:
            return q;
    ...
    function ti(l, h) {
      return h = h ?? o, !!h && (typeof l == "number" || k.test(l)) && l > -1 && l % 1 == 0 && l < h;
    }
    function ni(l) {
      var h = typeof l;
      return h == "string" || h == "number" || h == "symbol" || h == "boolean" ? l !== "__proto__" : l === null;
    ...
    var jr = Lr(/* @__PURE__ */ (function() {
      ...
      return ut(l) && $e.call(l, "callee") && !un.call(l, "callee");
    }, mn = Array.isArray;
    function Kn(l) {
      ...
      compose(d) {
        ...
        for (; y.hasNext() || p.hasNext(); )
          if (p.peekType() === "insert")
            ...
            const R = Math.min(y.peekLength(), p.peekLength()), L = y.next(R), D = p.next(R);
            if (D.retain) {
              const _ = {};
              if (typeof L.retain == "number")
                _.retain = typeof D.retain == "number" ? R : D.retain;
              else if (typeof D.retain == "number")
                L.retain == null ? _.insert = L.insert : _.retain = L.retain;
              else {
                const G = L.retain == null ? "insert" : "retain", [re, le, de] = u(L[G], D.retain), g = f.getHandler(re);
                _[G] = {
                  [re]: g.compose(le, de, G === "retain")
                };
              }
              const F = i.default.compose(L.attributes, D.attributes, typeof L.retain == "number");
              if (F && (_.attributes = F), A.push(_), !p.hasNext() && s(A.ops[A.ops.length - 1], _)) {
                const G = new f(y.rest());
                return A.concat(G).chop();
              }
            } else typeof D.delete == "number" && (typeof L.retain == "number" || typeof L.retain == "object" && L.retain !== null) && A.push(D);
          }
        return A.chop();
      }
      concat(d) {
      ...
      diff(d, y) {
        ...
        return w.forEach((L) => {
          ...
          for (; D > 0; ) {
            ...
            switch (L[0]) {
              case t.INSERT:
                _ = Math.min(R.peekLength(), D), v.push(R.next(_));
                break;
              case t.DELETE:
                _ = Math.min(D, A.peekLength()), A.next(_), v.delete(_);
                break;
              case t.EQUAL:
                _ = Math.min(A.peekLength(), R.peekLength(), D);
                const F = A.next(_), G = R.next(_);
                s(F.insert, G.insert) ? v.retain(_, i.default.diff(F.attributes, G.attributes)) : v.push(G).delete(_);
                break;
            }
            D -= _;
          }
...
`) {
        ...
        for (; p.hasNext(); ) {
          if (p.peekType() !== "insert")
            return;
          const A = p.peek(), R = o.default.length(A) - p.peekLength(), L = typeof A.insert == "string" ? A.insert.indexOf(y, R) - R : -1;
          if (L < 0)
            v.push(p.next());
          else if (L > 0)
            v.push(p.next(L));
        ...
        return this.reduce((p, v) => {
          if (v.insert)
            ...
            if (v.delete || typeof v.retain == "number") {
              ...
              const w = d.slice(p, p + 1), A = new a.default(w.ops).next(), [R, L, D] = u(v.retain, A.insert), _ = f.getHandler(R);
              return y.retain({ [R]: _.invert(L, D) }, i.default.invert(v.attributes, A.attributes)), p + 1;
            }
          }
          return p;
        }, 0), y.chop();
      ...
      transform(d, y = !1) {
        ...
        for (; v.hasNext() || w.hasNext(); )
          if (v.peekType() === "insert" && (y || w.peekType() !== "insert"))
            ...
            const R = Math.min(v.peekLength(), w.peekLength()), L = v.next(R), D = w.next(R);
            if (L.delete)
              continue;
            if (D.delete)
              A.push(D);
            else {
              const _ = L.retain, F = D.retain;
              let G = typeof F == "object" && F !== null ? F : R;
              if (typeof _ == "object" && _ !== null && typeof F == "object" && F !== null) {
                const re = Object.keys(_)[0];
                if (re === Object.keys(F)[0]) {
                  const le = f.getHandler(re);
                  le && (G = {
                    [re]: le.transform(_[re], F[re], y)
                  });
                }
              }
              A.retain(G, i.default.transform(L.attributes, D.attributes, y));
            }
          }
        return A.chop();
      }
...
const ht = class ht extends lo {
  ...
  formatAt(e, t, r, s) {
    if (ht.compare(this.statics.blotName, r) < 0 && this.scroll.query(r, J.BLOT)) {
      const i = this.isolate(e, t);
      s && i.wrap(r, s);
    } else
...
$(ht, "allowedChildren", [ht, st, Me, nt]), // Lower index means deeper in the DOM tree, since not found (-1) is for embeds
$(ht, "order", [
  "cursor",
  "inline",
  // Must be lower
...
class Ae extends hr {
  ...
  formatAt(t, r, s, i) {
    r <= 0 || (this.scroll.query(s, J.BLOCK) ? t + r === this.length() && this.format(s, i) : super.formatAt(t, Math.min(r, this.length() - t - 1), s, i), this.cache = {});
  }
  insertAt(t, r, s) {
    if (s != null) {
...
Ae.tagName = "P";
Ae.defaultChild = st;
Ae.allowedChildren = [st, mt, Me, nt];
class Ve extends Me {
  attach() {
  ...
  format(e, t) {
    const r = this.scroll.query(e, J.BLOCK_ATTRIBUTE);
...
Ve.scope = J.BLOCK_BLOT;
function La(n) {
  let e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !0;
  return n.descendants(Ce).reduce((t, r) => r.length() === 0 ? t : t.insert(r.value(), ze(r, {}, e)), new Z()).insert(`
`, ze(n));
}
function ze(n) {
...
const He = class He extends Me {
  ...
  format(e, t) {
    ...
    let r = this, s = 0;
    for (; r != null && r.statics.scope !== J.BLOCK_BLOT; )
...
$(He, "blotName", "cursor"), $(He, "className", "ql-cursor"), $(He, "tagName", "span"), $(He, "CONTENTS", "\uFEFF");
let Cn = He;
var di = { exports: {} }, hl;
function Bp() {
  return hl || (hl = 1, (function(n) {
    ...
    a.prototype.eventNames = function() {
      ...
      var w = this._events[v], A = arguments.length, R, L;
      if (w.fn) {
        ...
        for (L = 0; L < D; L++)
          switch (w[L].once && this.removeListener(u, w[L].fn, void 0, !0), A) {
            case 1:
              ...
              break;
            case 2:
              w[L].fn.call(w[L].context, f);
              break;
            case 3:
              w[L].fn.call(w[L].context, f, m);
              break;
            case 4:
              w[L].fn.call(w[L].context, f, m, d);
              break;
            default:
              if (!R) for (_ = 1, R = new Array(A - 1); _ < A; _++)
                R[_ - 1] = arguments[_];
              w[L].fn.apply(w[L].context, R);
          }
      }
      return !0;
...
qa.level = _t.level;
const pi = _t("quill:events"), Dp = ["selectionchange", "mousedown", "mouseup", "click"];
Dp.forEach((n) => {
...
class Up {
  ...
  format(e, t) {
    this.scroll.update();
    const r = this.getNativeRange();
    if (!(r == null || !r.native.collapsed || this.scroll.query(e, J.BLOCK))) {
  ...
  update() {
    ...
    if (this.lastRange = r, this.lastNative = s, this.lastRange != null && (this.savedRange = this.lastRange), !oo(t, this.lastRange)) {
      ...
      const i = [V.events.SELECTION_CHANGE, An(this.lastRange), An(t), e];
...
`) && (t <= o || !!this.scroll.descendant(Ve, o)[0]), this.scroll.insertAt(o, p);
          ...
          u = Ge.AttributeMap.diff(A, u) || {};
        } else if (typeof a.insert == "object") {
          const p = Object.keys(a.insert)[0];
          if (p == null) return o;
          const v = this.scroll.query(p, J.INLINE) != null;
          if (v)
            (t <= o || this.scroll.descendant(Ve, o)[0]) && (m = !0);
          else if (o > 0) {
            const [w, A] = this.scroll.descendant(Ce, o - 1);
            w instanceof nt ? w.value()[A] !== `
` && (f = !0) : w instanceof Me && w.statics.scope === J.INLINE_BLOT && (f = !0);
          }
  ...
  formatLine(e, t) {
    ...
    const s = new Z().retain(e).retain(t, An(r));
  ...
  insertContents(e, t) {
    const r = fl(t), s = new Z().retain(e).concat(r);
...
`), this.scroll.insertAt(e, t), Object.keys(r).forEach((s) => {
    ...
    }), this.update(new Z().retain(e).insert(t, An(r)));
  }
  isBlank() {
...
`));
    const u = this.getContents(e, t + o).diff(new Z().insert(r).concat(a)), f = new Z().retain(e).concat(u);
  ...
  update(e) {
    ...
    t[0].target.data.match($p) && this.scroll.find(t[0].target)) {
      const i = this.scroll.find(t[0].target), o = ze(i), a = i.offset(this.scroll), c = t[0].oldValue.replace(Cn.CONTENTS, ""), u = new Z().insert(c), f = new Z().insert(i.value()), m = r && {
        oldRange: dl(r.oldRange, -a),
        newRange: dl(r.newRange, -a)
      };
      e = new Z().retain(a).concat(u.diff(f, m)).reduce((y, p) => p.insert ? y.insert(p.insert, o) : y.push(p), new Z()), this.delta = s.compose(e);
    } else
...
}, Sn = _t("quill"), Jr = new On();
tt.uiClass = "ql-ui";
const Xe = class Xe {
  static debug(e) {
    e === !0 && (e = "log"), _t.level(e);
  }
  static find(e) {
  ...
  constructor(e) {
    ...
    if (this.scroll = new i(this.options.registry, this.root, {
      ...
      Ye.call(this, () => {
        const m = new Z().retain(o.offset(this)).retain({
...
`
  ...
  deleteText(e, t, r) {
    return [e, t, , r] = xt(e, t, r), Ye.call(this, () => this.editor.deleteText(e, t), r, e, -1 * t);
  }
  disable() {
    this.enable(!1);
  }
  ...
  format(e, t) {
    ...
    return Ye.call(this, () => {
      ...
      let i = new Z();
      if (s == null) return i;
      if (this.scroll.query(e, J.BLOCK))
  ...
  getContents() {
    ...
    return [e, t] = xt(e, t), this.editor.getContents(e, t);
  }
  getFormat() {
  ...
  getSemanticHTML() {
    ...
    return typeof e == "number" && (t = t ?? this.getLength() - e), [e, t] = xt(e, t), this.editor.getHTML(e, t);
  }
  getText() {
    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, t = arguments.length > 1 ? arguments[1] : void 0;
    return typeof e == "number" && (t = t ?? this.getLength() - e), [e, t] = xt(e, t), this.editor.getText(e, t);
  }
  hasFocus() {
  ...
  insertText(e, t, r, s, i) {
    let o;
    return [e, , o, i] = xt(e, 0, r, s, i), Ye.call(this, () => this.editor.insertText(e, t, o), i, e, t.length);
  }
  isEnabled() {
  ...
  removeFormat(e, t, r) {
    return [e, t, , r] = xt(e, t, r), Ye.call(this, () => this.editor.removeFormat(e, t), r, e);
  }
  ...
  setSelection(e, t, r) {
    e == null ? this.selection.setRange(null, t || Xe.sources.API) : ([e, t, , r] = xt(e, t, r), this.selection.setRange(new Qt(Math.max(0, e), t), r), r !== V.sources.SILENT && this.scrollSelectionIntoView());
  }
  setText(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : V.sources.API;
  ...
  updateContents(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : V.sources.API;
    return Ye.call(this, () => (e = new Z(e), this.editor.applyDelta(e)), t, !0);
  }
};
$(Xe, "DEFAULTS", {
  bounds: null,
  ...
  registry: Jr,
  theme: "default"
}), $(Xe, "events", V.events), $(Xe, "sources", V.sources), $(Xe, "version", "2.0.2"), $(Xe, "imports", {
  delta: Z,
  parchment: Lp,
  "core/module": it,
  "core/theme": Rn
...
function yl(n) {
  return n instanceof Ae || n instanceof Ve;
}
function vl(n) {
...
class xn extends ao {
  ...
  insertAt(e, t, r) {
    if (e >= this.length())
      if (r == null || this.scroll.query(t, J.BLOCK) == null) {
...
`) ? s.insertAt(0, t.slice(0, -1), r) : s.insertAt(0, t, r);
  ...
  insertBefore(e, t) {
    if (e.statics.scope === J.INLINE_BLOT) {
...
`))), s = r.pop();
    ...
    const i = r.shift();
    if (i) {
      const c = i.type === "block" && (i.delta.length() === 0 || !this.descendant(Ve, e)[0] && e < this.length()), u = i.type === "block" ? i.delta : new Z().insert({
        [i.key]: i.value
      });
      vi(this, e, u);
...
`);
          ...
          if (!o) return;
          this.query(o, J.INLINE) ? r.push(s) : (r.length() && t.push({
            type: "block",
            delta: r,
            attributes: {}
          }), r = new Z(), t.push({
  ...
  createBlock(e, t) {
    ...
    Object.entries(e).forEach((a) => {
      let [c, u] = a;
      this.query(c, J.BLOCK & J.BLOT) != null ? r = c : s[c] = u;
    });
...
$(xn, "blotName", "scroll"), $(xn, "className", "ql-editor"), $(xn, "tagName", "DIV"), $(xn, "defaultChild", Ae), $(xn, "allowedChildren", [Ae, Ve, sn]);
function vi(n, e, t) {
  t.reduce((r, s) => {
    ...
    if (s.insert != null) {
      if (typeof s.insert == "string") {
        ...
        if (a == null) return r;
        if (n.insertAt(r, a, s.insert[a]), n.scroll.query(a, J.INLINE) != null) {
...
}, Qp = new pt("align", "align", uo), ka = new rt("align", "ql-align", uo), Ia = new Ut("align", "text-align", uo);
class ja extends Ut {
  value(e) {
    let t = super.value(e);
...
const em = new rt("color", "ql-color", {
  scope: J.INLINE
}), ho = new ja("color", "color", {
  scope: J.INLINE
}), tm = new rt("background", "ql-bg", {
  scope: J.INLINE
...
const mo = {
  scope: J.BLOCK,
  whitelist: ["rtl"]
}, Ba = new pt("direction", "dir", mo), Pa = new rt("direction", "ql-direction", mo), Ma = new Ut("direction", "direction", mo), Da = {
  scope: J.INLINE,
...
const $a = new nm("font", "font-family", Da), Fa = new rt("size", "ql-size", {
  scope: J.INLINE,
  whitelist: ["small", "large", "huge"]
}), Ha = new Ut("size", "font-size", {
  scope: J.INLINE,
  whitelist: ["10px", "18px", "32px"]
}), rm = _t("quill:keyboard"), sm = /Mac/i.test(navigator.platform) ? "metaKey" : "ctrlKey";
class bs extends it {
  static match(e, t) {
  ...
  handleBackspace(e, t) {
    ...
    let o = new Z().retain(e.index - r).delete(r);
    if (t.offset === 0) {
      ...
      if (a && !(a.statics.blotName === "block" && a.length() <= 1)) {
        ...
        if (s = Ge.AttributeMap.diff(u, f) || {}, Object.keys(s).length > 0) {
          const m = new Z().retain(e.index + i.length() - 2).retain(1, s);
          o = o.compose(m);
        }
      }
    }
  ...
  handleDelete(e, t) {
    ...
    let s = {};
    const [i] = this.quill.getLine(e.index);
    let o = new Z().retain(e.index).delete(r);
  ...
  handleEnter(e, t) {
    const r = Object.keys(t.format).reduce((i, o) => (this.quill.scroll.query(o, J.BLOCK) && !Array.isArray(t.format[o]) && (i[o] = t.format[o]), i), {}), s = new Z().retain(e.index).delete(e.length).insert(`
`, r);
...
`);
    ...
    "list autofill": {
      ...
      handler(n, e) {
        ...
        const o = new Z().retain(n.index - s).delete(t + 1).retain(r.length() - 2 - s).retain(1, {
          list: i
        });
...
function Yr(n, e) {
  return {
    ...
    handler(r) {
      ...
      return i instanceof Me ? (n === "ArrowLeft" ? e ? this.quill.setSelection(r.index - 1, r.length + 1, C.sources.USER) : this.quill.setSelection(r.index - 1, C.sources.USER) : e ? this.quill.setSelection(r.index, r.length + 1, C.sources.USER) : this.quill.setSelection(r.index + r.length + 1, C.sources.USER), !1) : !0;
    }
  };
}
function wi(n) {
...
}, Em = _t("quill:clipboard"), xm = [[Node.TEXT_NODE, Im], [Node.TEXT_NODE, Al], ["br", _m], [Node.ELEMENT_NODE, Al], [Node.ELEMENT_NODE, Sm], [Node.ELEMENT_NODE, Nm], [Node.ELEMENT_NODE, qm], ["li", Rm], ["ol, ul", Lm], ["pre", Om], ["tr", km], ["b", Ei("bold")], ["i", Ei("italic")], ["strike", Ei("strike")], ["style", Cm]], Tm = [Qp, Ba].reduce((n, e) => (n[e.keyName] = e, n), {}), Tl = [Ia, fo, ho, Ma, $a, Ha].reduce((n, e) => (n[e.keyName] = e, n), {});
class za extends it {
  constructor(e, t) {
...
`) && (i.ops[i.ops.length - 1].attributes == null || s.table) ? i.compose(new Z().retain(i.length() - 1).delete(1)) : i;
  ...
  dangerouslyPasteHTML(e, t) {
    ...
    if (typeof e == "string") {
      ...
      this.quill.updateContents(new Z().retain(e).concat(s), r), this.quill.setSelection(e + s.length(), C.sources.SILENT);
    }
  }
  onCaptureCopy(e) {
    var o, a;
...
`);
  ...
  onPaste(e, t) {
    ...
    const a = new Z().retain(e.index).delete(e.length).concat(o);
...
function bo(n, e, t, r, s) {
  return e.nodeType === e.TEXT_NODE ? r.reduce((i, o) => o(e, i, n), new Z()) : e.nodeType === e.ELEMENT_NODE ? Array.from(e.childNodes || []).reduce((i, o) => {
    let a = bo(n, o, t, r, s);
...
function Nm(n, e, t) {
  const r = pt.keys(n), s = rt.keys(n), i = Ut.keys(n), o = {};
  return r.concat(s).concat(i).forEach((a) => {
    let c = t.query(a, J.ATTRIBUTE);
    c != null && (o[c.attrName] = c.value(n), o[c.attrName]) || (c = Tm[a], c != null && (c.attrName === a || c.keyName === a) && (o[c.attrName] = c.value(n) || void 0), c = Tl[a], c != null && (c.attrName === a || c.keyName === a) && (c = Tl[a], o[c.attrName] = c.value(n) || void 0));
...
class Va extends it {
  ...
  transform(t) {
    Nl(this.stack.undo, t), Nl(this.stack.redo, t);
  }
  undo() {
...
`) : t.attributes != null ? Object.keys(t.attributes).some((r) => n.query(r, J.BLOCK) != null) : !1;
}
function Bm(n, e) {
...
class Mm extends it {
  ...
  replaceText(e) {
    ...
    if (t) {
      ...
      this.deleteRange(e), this.quill.updateContents(new Z().retain(e.index).insert(t, r), C.sources.USER);
    } else
      this.deleteRange(e);
...
`, i = Ke.formats(this.children.head.domNode);
    if (t || this.forceNext || this.cachedText !== s) {
      if (s.trim().length > 0 || this.cachedText == null) {
        const o = this.children.reduce((c, u) => c.concat(La(u, !1)), new Z()), a = e(s, i);
        o.diff(a).reduce((c, u) => {
          let {
            retain: f,
            attributes: m
...
class Za extends it {
  static register() {
    C.register(At, !0), C.register(Ke, !0), C.register(ir, !0);
  }
  constructor(e, t) {
...
`, {
    ...
    return r.classList.add(Le.className), r.innerHTML = Vm(this.options.hljs, t, e), bo(this.quill.scroll, r, [(s, i) => {
      const o = nr.value(s);
      return o ? i.compose(new Z().retain(i.length(), {
        [At.blotName]: o
      })) : i;
    }], [(s, i) => s.data.split(`
...
$(Nt, "blotName", "table-row"), $(Nt, "tagName", "TR");
class dt extends sn {
}
$(dt, "blotName", "table-body"), $(dt, "tagName", "TBODY");
class Ln extends sn {
  balanceCells() {
    const e = this.descendants(Nt), t = e.reduce((r, s) => Math.max(s.children.length, r), 0);
    e.forEach((r) => {
  ...
  insertRow(e) {
    ...
    const r = yo(), s = this.scroll.create(Nt.blotName);
...
dt.allowedChildren = [Nt];
Nt.requiredContainer = dt;
Nt.allowedChildren = [et];
et.requiredContainer = Nt;
function yo() {
  return `row-${Math.random().toString(36).slice(2, 6)}`;
}
class Gm extends it {
  static register() {
    C.register(et), C.register(Nt), C.register(dt), C.register(Ln);
  }
  constructor() {
  ...
  attach(e) {
    ...
    e.addEventListener(r, (s) => {
      ...
      if (this.handlers[t] != null)
        ...
        this.quill.updateContents(new Z().retain(o.index).delete(o.length).insert({
          [t]: i
        }), C.sources.USER);
      } else
      ...
      if (n != null)
        if (n.length === 0) {
          ...
          Object.keys(e).forEach((t) => {
            this.quill.scroll.query(t, J.INLINE) != null && this.quill.format(t, !1, C.sources.USER);
          });
        } else
...
class vr extends Rn {
  ...
  buildPickers(e, t) {
    this.pickers = Array.from(e).map((s) => {
      ...
      return s.querySelector("option") == null && (s.classList.contains("ql-font") ? Yn(s, qg) : s.classList.contains("ql-header") ? Yn(s, kg) : s.classList.contains("ql-size") && Yn(s, Ig)), new ys(s);
    });
    const r = () => {
...
const Mg = ({
  ...
  const [e, t] = Oe(
    () => n != null && n.length ? n.map((_, F) => ({ id: `default-${F}`, email: _ })) : []
  ), [r, s] = Oe([]), [i, o] = Oe([]), [a, c] = Oe(!1), [u, f] = Oe(!1), [m, d] = Oe(""), [y, p] = Oe(""), [v, w] = Oe(""), A = (_, F) => {
    const G = _.trim();
    if (!G || !Dg(G))
      return;
    const re = {
    ...
    if (F === "to") {
      if (e.some((le) => le.email.toLowerCase() === G.toLowerCase()))
        return;
      t((le) => [...le, re]), d("");
    } else if (F === "cc") {
      if (r.some((le) => le.email.toLowerCase() === G.toLowerCase()))
        return;
      s((le) => [...le, re]), p("");
    } else {
      if (i.some((le) => le.email.toLowerCase() === G.toLowerCase()))
        return;
      o((le) => [...le, re]), w("");
    }
  };
  return {
    ...
    setBccInput: w,
    addRecipient: A,
    handleRecipientInputKeyDown: (_, F) => {
      if (_.key === "Enter" || _.key === ",") {
        _.preventDefault();
        const G = F === "to" ? m : F === "cc" ? y : v;
        G && A(G, F);
      }
    },
    handleRecipientInputBlur: (_) => {
      const F = _ === "to" ? m : _ === "cc" ? y : v;
      F && A(F, _);
    },
    removeRecipient: (_, F) => {
      F === "to" ? t((G) => G.filter((re) => re.id !== _)) : F === "cc" ? s((G) => G.filter((re) => re.id !== _)) : o((G) => G.filter((re) => re.id !== _));
    }
  };
}, $g = (n) => {
...
}, Fg = ({ apiAdapter: n, config: e, onClose: t }) => {
  const [r, s] = Oe(""), [i, o] = Oe(""), [a, c] = Oe(!1), [u, f] = Oe(!1), [m, d] = Oe([]), [y, p] = Oe(!1), {
    ...
    bccInput: E,
    setBccInput: P,
    handleRecipientInputKeyDown: I,
    handleRecipientInputBlur: N,
    removeRecipient: B
  ...
  Tn(() => {
    ...
    queueMicrotask(() => {
      var ne;
      k.subject && s(k.subject.toLowerCase().startsWith("re:") ? k.subject : `Re: ${k.subject}`);
      const Y = (Q) => Q ? Q.split(",").map((oe) => oe.trim()).filter(Boolean).map((oe) => ({
        id: Date.now().toString() + Math.random().toString(36).substr(2, 9),
        email: oe
      })) : [];
      if (k.to && w(Y(k.to)), k.cc) {
        const Q = Y(k.cc);
        Q.length > 0 && (R(Q), F(!0));
      }
      if (k.bcc) {
      ...
      (ne = k.attachments) != null && ne.length && z(k.attachments.map((Q) => ({
        id: Q.name || Q.file_name || Math.random().toString(36).substr(2, 9),
        name: Q.name,
        fileUrl: Q.file_url,
        isUploading: !1
      })));
    ...
    var ne;
    if (!((ne = e.defaultToEmails) != null && ne.length) || k != null && k.to) return;
    const W = e.defaultToEmails;
    queueMicrotask(() => {
      w(
        (Q) => Q.length === 0 ? W.map((oe, ae) => ({ id: `default-${ae}`, email: oe })) : Q
      );
    });
  }, [e.defaultToEmails, k, w]);
  const K = kc(() => {
    let W = "", Y;
    if (k != null && k.content) {
      const ne = k.date && k.time ? `${k.date} at ${k.time}` : "the previous message";
      W = `<br><hr><br><div><b>From:</b> ${k.senderName || k.to || "User"}<br><b>Sent:</b> ${ne}<br><b>Subject:</b> ${k.subject || ""}</div><br><div>${k.content}</div>`;
    }
    return k != null && k.in_reply_to && (Y = k.in_reply_to), { quotedContent: W, inReplyTo: Y };
  }, [k]);
  return Tn(() => {
    if (!u || !n.getTemplates) return;
    let W = !0;
    return m.length === 0 && p(!0), n.getTemplates().then((Y) => {
      W && (d(Y), p(!1));
    }).catch(() => {
      W && p(!1);
    }), () => {
    ...
    handleAttachClick: H,
    handleSend: async () => {
      var Ue, Ct, $t, Ft, Pe, bt, an, lt;
      if (v.length === 0) {
        (Ue = n.showWarning) == null || Ue.call(n, "Validation Error", "Please add at least one recipient");
        return;
      }
      if (!r.trim()) {
        (Ct = n.showWarning) == null || Ct.call(n, "Validation Error", "Please enter a subject");
        return;
      }
      if (M.filter((ge) => ge.isUploading).length > 0) {
        ($t = n.showWarning) == null || $t.call(n, "Upload In Progress", "Please wait for all files to finish uploading");
        return;
      }
      if (M.filter((ge) => ge.uploadError).length > 0) {
        (Ft = n.showWarning) == null || Ft.call(n, "Upload Error", "Some files failed to upload. Please remove them and try again.");
        return;
      }
      const ne = v.map((ge) => ge.email).join(", "), Q = A.length > 0 ? A.map((ge) => ge.email).join(", ") : void 0, oe = L.length > 0 ? L.map((ge) => ge.email).join(", ") : void 0, ae = M.filter((ge) => ge.name).map((ge) => ge.name);
      let me = i ? `<div class="ql-editor read-mode">${i}</div>` : "";
      const { quotedContent: ve, inReplyTo: De } = K();
      me += ve;
      const We = [...e.links ?? []];
      (Pe = e.activeLeadName) != null && Pe.trim() && (We.some(
        (Rt) => Rt.link_doctype === e.activeLeadDoctype && Rt.link_name === e.activeLeadName
      ) || We.push({ link_doctype: e.activeLeadDoctype, link_name: e.activeLeadName }));
      const Ot = We.length > 0 ? We : void 0, se = {
        recipients: ne,
        subject: r,
        content: me,
        cc: Q,
      ...
      c(!0);
      try {
        const ge = await n.sendEmail(se);
        ge != null && ge.name && (De && n.updateCommunicationStatus && n.updateCommunicationStatus(De, "Replied").catch(() => {
        }), (bt = n.showNotification) == null || bt.call(n, "Success", "Email sent successfully"), (an = n.onEmailSent) == null || an.call(n), t());
      } catch {
        (lt = n.showError) == null || lt.call(n, "Error", "Failed to send email");
      } finally {
        c(!1);
      }
    },
...
}, Wg = ot("Date"), Zg = ot("File"), Jg = (n) => !!(n && typeof n.uri < "u"), Yg = (n) => n && typeof n.getParts < "u", Xg = ot("Blob"), Qg = ot("FileList"), e1 = (n) => Er(n) && je(n.pipe);
function t1() {
  return typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {};
}
const kl = t1(), Il = typeof kl.FormData < "u" ? kl.FormData : void 0, n1 = (n) => {
  let e;
...
}, r1 = ot("URLSearchParams"), [s1, i1, o1, l1] = [
  "ReadableStream",
  "Request",
  "Response",
  "Headers"
].map(ot), a1 = (n) => n.trim ? n.trim() : n.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const c1 = (n, e, t, { allOwnKeys: r } = {}) => (xr(
  ...
  for (; (t = n.exec(e)) !== null; )
    r.push(t);
  return r;
}, y1 = ot("HTMLFormElement"), v1 = (n) => n.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function(t, r, s) {
  return r.toUpperCase() + s;
}), jl = (({ hasOwnProperty: n }) => (e, t) => n.call(e, t))(Object.prototype), w1 = ot("RegExp"), uc = (n, e) => {
...
const S1 = (n) => {
  ...
  return t(n, 0);
}, _1 = ot("AsyncFunction"), O1 = (n) => n && (Er(n) || je(n)) && je(n.then) && je(n.catch), hc = ((n, e) => n ? setImmediate : e ? ((t, r) => (Zt.addEventListener(
  "message",
  ({ source: s, data: i }) => {
...
const k1 = T.toFlatObject(T, {}, null, function(e) {
...
function xs(n, e, t) {
  ...
  function f(p, v, w) {
    ...
    if (p && !w && typeof p == "object") {
      ...
      else if (T.isArray(p) && q1(p) || (T.isFileList(p) || T.endsWith(v, "[]")) && (A = T.toArray(p)))
        return v = dc(v), A.forEach(function(L, D) {
  ...
  function y(p, v) {
    if (!T.isUndefined(p)) {
      ...
      m.push(p), T.forEach(p, function(A, R) {
        (!(T.isUndefined(A) || A === null) && s.call(e, A, T.isString(R) ? R.trim() : R, v, d)) === !0 && y(A, v ? v.concat(R) : [R]);
      }), m.pop();
    }
  }
  if (!T.isObject(n))
...
function mc(n, e, t) {
  if (!e)
    return n;
  const r = t && t.encode || I1, s = T.isFunction(t) ? {
    serialize: t
  } : t, i = s && s.serialize;
  let o;
...
}, To = typeof window < "u" && typeof document < "u", Yi = typeof navigator == "object" && navigator || void 0, D1 = To && (!Yi || ["ReactNative", "NativeScript", "NS"].indexOf(Yi.product) < 0), U1 = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", $1 = To && window.location.href || "http://localhost", F1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: To,
...
const wc = (n) => {
  ...
  return new Promise(function(t, r) {
    ...
    "onloadend" in w ? w.onloadend = A : w.onreadystatechange = function() {
      ...
      w && (r(new ee("Request aborted", ee.ECONNABORTED, n, w)), w = null);
    }, w.onerror = function(D) {
      const _ = D && D.message ? D.message : "Network Error", F = new ee(_, ee.ERR_NETWORK, n, w);
      ...
      s.timeoutErrorMessage && (D = s.timeoutErrorMessage), r(
        new ee(
          D,
          _.clarifyTimeoutError ? ee.ETIMEDOUT : ee.ECONNABORTED,
          n,
          w
        )
      ), w = null;
    }, i === void 0 && o.setContentType(null), "setRequestHeader" in w && T.forEach(o.toJSON(), function(D, _) {
      w.setRequestHeader(_, D);
    }), T.isUndefined(s.withCredentials) || (w.withCredentials = !!s.withCredentials), a && a !== "json" && (w.responseType = s.responseType), u && ([d, p] = us(u, !0), w.addEventListener("progress", d)), c && w.upload && ([m, y] = us(c), w.upload.addEventListener("progress", m), w.upload.addEventListener("loadend", y)), (s.cancelToken || s.signal) && (f = (L) => {
      w && (r(!L || L.type ? new Ar(null, n, w) : L), w.abort(), w = null);
  ...
  if (e || t) {
    ...
    const i = function(u) {
      if (!s) {
        ...
        r.abort(
          f instanceof ee ? f : new Ar(f instanceof Error ? f.message : f)
        );
      }
    };
    let o = e && setTimeout(() => {
  ...
  return async (p) => {
    ...
    const P = q && q.unsubscribe && (() => {
      q.unsubscribe();
    });
    let I;
    try {
      if (F && u && w !== "get" && w !== "head" && (I = await y(re, A)) !== 0) {
        let x = new t(v, {
          method: "POST",
          body: A,
          duplex: "half"
        }), j;
        if (T.isFormData(A) && (j = x.headers.get("content-type")) && re.setContentType(j), x.body) {
          const [H, k] = Dl(
            I,
            us(Ul(F))
          );
      ...
      T.isString(le) || (le = le ? "include" : "omit");
      const N = i && "credentials" in t.prototype, B = {
        ...de,
        signal: q,
        ...
        body: A,
        duplex: "half",
        credentials: N ? le : void 0
      };
      E = i && new t(v, B);
      let M = await (i ? g(E, de) : g(v, B));
      const z = f && (G === "stream" || G === "response");
      if (f && (_ || z && P)) {
        const x = {};
        ["status", "statusText", "headers"].forEach((K) => {
          x[K] = M[K];
        });
        const j = T.toFiniteNumber(M.headers.get("content-length")), [H, k] = _ && Dl(
          j,
          us(Ul(_), !0)
        ) || [];
        M = new r(
      ...
      G = G || "text";
      let U = await m[T.findKey(m, G) || "text"](
        M,
        p
      );
      return !z && P && P(), await new Promise((x, j) => {
        yc(x, j, {
          data: U,
          headers: Be.from(M.headers),
          status: M.status,
      ...
      ) : ee.from(N, N && N.code, p, E, N && N.response);
    }
  };
...
function Wl(n) {
  return Ni(n), n.headers = Be.from(n.headers), n.data = Ai.call(n, n.transformRequest), ["post", "put", "patch"].indexOf(n.method) !== -1 && n.headers.setContentType("application/x-www-form-urlencoded", !1), xc.getAdapter(n.adapter || Tr.adapter, n)(n).then(
    function(r) {
      return Ni(n), r.data = Ai.call(n, n.transformResponse, r), r.headers = Be.from(r.headers), r;
    },
    function(r) {
      return bc(r) || (Ni(n), r && r.response && (r.response.data = Ai.call(
        n,
        n.transformResponse,
        r.response
...
function No({
  ...
  const p = $r(() => Eb(n, y), [n, y]), v = $r(() => xb(p), [p]), w = $r(
    ...
    () => ({
      sendEmail: async (R) => {
        ...
        try {
          ...
          if (_ != null && _._server_messages)
            try {
              const G = JSON.parse(_._server_messages);
              if (Array.isArray(G) && G.length > 0) {
                const re = JSON.parse(G[0]);
                if (re.message)
            ...
            return d == null || d("Error", _.exception), {};
          const F = ((L = _ == null ? void 0 : _.data) == null ? void 0 : L.message) || (_ == null ? void 0 : _.message) || _;
          return { name: F == null ? void 0 : F.name };
        } catch {
      ...
      uploadFile: async (R) => {
        var F;
        const D = (await v.uploadFile(R)).data, _ = ((F = D == null ? void 0 : D.data) == null ? void 0 : F.message) || (D == null ? void 0 : D.message) || D;
        return {
      ...
      getTemplates: async () => {
        var D;
        return (((D = (await v.getTemplates()).data) == null ? void 0 : D.message) || []).map((_) => ({
          id: _.name,
          name: _.subject || _.name,
          body: _.response || _.response_html || ""
        }));
      },
      updateCommunicationStatus: async (R, L) => {
        await v.updateCommunication(R, L);
      },
      showNotification: (R, L) => f == null ? void 0 : f(R, L),
      showWarning: (R, L) => m == null ? void 0 : m(R, L),
      showError: (R, L) => d == null ? void 0 : d(R, L),
      onEmailSent: u
    }),
    [v, u, f, m, d]
  );
...
const Sc = ({
  ...
  var Ot;
  const { config: A, apiAdapter: R } = No({
    baseURL: t,
    currentUserFullName: r,
    defaultToEmails: s,
    referenceName: i,
    ...
    replyData: Y,
    // Handlers
    handleRecipientInputKeyDown: ne,
    handleRecipientInputBlur: Q,
    removeRecipient: oe,
    handleFileSelect: ae,
    removeAttachment: me,
    handleAttachClick: ve,
    handleSend: De,
    handleTemplateSelect: We
  } = Fg({ apiAdapter: L, config: D, onClose: m });
  return /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer", children: [
    /* @__PURE__ */ O.jsx("div", { className: "ecw-email-composer-header", children: /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-from", children: [
      ...
      /* @__PURE__ */ O.jsx("span", { className: "ecw-email-composer-sender-name", children: ((Ot = D.currentUserFullName) == null ? void 0 : Ot.trim()) || "User" })
    ] }) }),
    ...
    /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-field", children: [
      ...
      /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-recipients-container", children: [
        /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-recipients", children: [
          G.map((se) => /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-tag", children: [
            /* @__PURE__ */ O.jsx("span", { children: se.email }),
            /* @__PURE__ */ O.jsx("button", { type: "button", className: "ecw-email-composer-tag-remove", onClick: () => oe(se.id, "to"), children: /* @__PURE__ */ O.jsx(Qn, { size: 14 }) })
          ] }, se.id)),
          /* @__PURE__ */ O.jsx(
            "input",
            {
        ...
        /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-actions", children: [
          /* @__PURE__ */ O.jsx("button", { type: "button", className: "ecw-email-composer-cc-bcc-btn", onClick: () => g(!de), children: "CC" }),
          /* @__PURE__ */ O.jsx("button", { type: "button", className: "ecw-email-composer-cc-bcc-btn", onClick: () => E(!q), children: "BCC" })
        ] })
      ] })
    ] }),
    de && /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-field", children: [
      ...
      /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-recipients", children: [
        re.map((se) => /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-tag", children: [
          /* @__PURE__ */ O.jsx("span", { children: se.email }),
          /* @__PURE__ */ O.jsx("button", { type: "button", className: "ecw-email-composer-tag-remove", onClick: () => oe(se.id, "cc"), children: /* @__PURE__ */ O.jsx(Qn, { size: 14 }) })
        ] }, se.id)),
        /* @__PURE__ */ O.jsx(
          "input",
          {
    ...
    q && /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-field", children: [
      ...
      /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-recipients", children: [
        le.map((se) => /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-tag", children: [
          /* @__PURE__ */ O.jsx("span", { children: se.email }),
          /* @__PURE__ */ O.jsx("button", { type: "button", className: "ecw-email-composer-tag-remove", onClick: () => oe(se.id, "bcc"), children: /* @__PURE__ */ O.jsx(Qn, { size: 14 }) })
        ] }, se.id)),
        /* @__PURE__ */ O.jsx(
          "input",
          {
    ...
    /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-body", children: [
      /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-editor-wrapper", children: [
        ...
        (Y == null ? void 0 : Y.content) && /* @__PURE__ */ O.jsxs("div", { className: "ecw-trail-email-preview", children: [
          ...
          /* @__PURE__ */ O.jsxs("div", { className: "ecw-trail-meta", children: [
            ...
            " ",
            Y.senderName || Y.to || "User",
            /* @__PURE__ */ O.jsx("br", {}),
            /* @__PURE__ */ O.jsx("b", { children: "Sent:" }),
            " ",
            Y.date && Y.time ? `${Y.date} at ${Y.time}` : "the previous message",
            /* @__PURE__ */ O.jsx("br", {}),
            /* @__PURE__ */ O.jsx("b", { children: "Subject:" }),
            " ",
            Y.subject || ""
          ] }),
          /* @__PURE__ */ O.jsx("div", { dangerouslySetInnerHTML: { __html: Tb(Y.content) } })
        ] })
      ] }),
      j.length > 0 && /* @__PURE__ */ O.jsx("div", { className: "ecw-email-composer-attachments", children: j.map((se) => {
        var Ue;
        return /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-attachment-tag", children: [
          /* @__PURE__ */ O.jsxs("span", { children: [
            se.fileName || se.name || ((Ue = se.file) == null ? void 0 : Ue.name),
            se.isUploading && " (Uploading...)",
            se.uploadError && ` (Error: ${se.uploadError})`,
            (se.fileName || se.name) && !se.isUploading && !se.uploadError && " ✓"
          ] }),
          /* @__PURE__ */ O.jsx("button", { type: "button", className: "ecw-email-composer-tag-remove", onClick: () => me(se.id), children: /* @__PURE__ */ O.jsx(Qn, { size: 14 }) })
        ] }, se.id);
      }) }),
      /* @__PURE__ */ O.jsx(Yl, { ref: K, onSelect: ae, multiple: !0, accept: "*/*" })
    ] }),
    /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-footer", children: [
      /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-footer-left", children: [
        /* @__PURE__ */ O.jsx("button", { type: "button", onClick: ve, title: "Attach file", className: "ecw-email-composer-icon-btn", children: /* @__PURE__ */ O.jsx(Kc, { size: 20, color: "#175353" }) }),
        /* @__PURE__ */ O.jsx(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ O.jsxs("div", { className: "ecw-email-composer-footer-right", children: [
        /* @__PURE__ */ O.jsx("button", { type: "button", onClick: m, className: "ecw-email-composer-btn ecw-email-composer-btn-secondary", disabled: ce, children: "Cancel" }),
        /* @__PURE__ */ O.jsx("button", { type: "button", onClick: De, className: "ecw-email-composer-btn ecw-email-composer-btn-primary", disabled: ce, children: ce ? "Sending..." : "Send" })
      ] })
    ] }),
    /* @__PURE__ */ O.jsx(
      Qi,
      {
        ...
        children: /* @__PURE__ */ O.jsx(Zc, { templates: te, onSelect: We, isLoading: W })
      }
    )
  ] });
}, Yb = ({
  ...
  RichTextEditor: A,
  modalSize: R = "800px",
  header: L = /* @__PURE__ */ O.jsx("h3", { style: { margin: 0, fontSize: "1.1rem" }, children: "Email Composer" })
}) => {
  const { config: D, apiAdapter: _ } = No({
    baseURL: t,
    currentUserFullName: r,
    defaultToEmails: s,
    referenceName: i,
  ...
  return /* @__PURE__ */ O.jsx(Qi, { open: m, onClose: d, width: R, header: L, children: /* @__PURE__ */ O.jsx(Sc, { apiAdapter: F, config: G, RichTextEditor: A, onClose: d }) });
}, Xb = ({
  apiAdapter: n,
  config: e,
  baseURL: t,
  ...
  const [le, de] = Oe(!1), { config: g, apiAdapter: q } = No({
    baseURL: t,
    currentUserFullName: r,
    defaultToEmails: s,
    referenceName: i,
    ...
    showError: G,
    token: re
  }), E = n || q, P = e || g, I = A !== void 0, N = I ? A : le, B = () => {
    I || de(!0), R == null || R();
  }, M = () => {
    I || de(!1), L == null || L();
  };
  return /* @__PURE__ */ O.jsxs(O.Fragment, { children: [
    p === "plain" ? /* @__PURE__ */ O.jsx(
      "button",
      {
        type: "button",
        className: v || y || "",
        ...
        style: {
          position: "relative",
          ...v && typeof v == "string" && v.includes("button") ? {} : { border: "none", background: "none", cursor: "pointer", padding: 0 }
        },
        children: d
      }
    ) : /* @__PURE__ */ O.jsxs("div", { className: `ecw-trigger-button ${y} ${v}`, onClick: B, children: [
    ...
    /* @__PURE__ */ O.jsx(
      Qi,
      {
        ...
        children: /* @__PURE__ */ O.jsx(Sc, { apiAdapter: E, config: P, RichTextEditor: m, onClose: M })
      }
    )
  ] });
}, _c = jc(void 0), Qb = ({
